...
localparam
    ...
    ADDR_IER         = 5'h08,
    ADDR_ISR         = 5'h0c,
    ADDR_GAIN_DATA_0 = 5'h10,
    ADDR_GAIN_CTRL   = 5'h14,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    RDIDLE           = 2'd0,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_GAIN_DATA_0)
            int_gain[31:0] <= (WDATA[31:0] & wmask) | (int_gain[31:0] & ~wmask);
    end
end
