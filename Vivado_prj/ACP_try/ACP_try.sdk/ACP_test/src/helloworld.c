...
void initPeripherals() {
	...
	doGain_cfg = XAdd_LookupConfig(XPAR_ADD_0_DEVICE_ID);
	if (doGain_cfg) {
		int status = XAdd_CfgInitialize(&doGain, doGain_cfg);
