...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/poll_OCM/poll_OCM.runs/design_1_auto_us_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_auto_us_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_auto_us_3.tcl
