...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/poll_OCM/poll_OCM.runs/design_1_s00_mmu_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_s00_mmu_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_s00_mmu_1.tcl
