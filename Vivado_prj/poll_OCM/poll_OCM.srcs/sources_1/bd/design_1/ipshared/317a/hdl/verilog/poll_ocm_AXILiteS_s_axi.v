...
`timescale 1ns/1ps
module poll_ocm_AXILiteS_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER         = 5'h08,
    ADDR_ISR         = 5'h0c,
    ADDR_ADDR_DATA_0 = 5'h10,
    ADDR_ADDR_CTRL   = 5'h14,
    ADDR_DATA_DATA_0 = 5'h18,
    ADDR_DATA_CTRL   = 5'h1c,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    RDIDLE           = 2'd0,
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_ADDR_DATA_0)
            int_addr[31:0] <= (WDATA[31:0] & wmask) | (int_addr[31:0] & ~wmask);
    end
end
