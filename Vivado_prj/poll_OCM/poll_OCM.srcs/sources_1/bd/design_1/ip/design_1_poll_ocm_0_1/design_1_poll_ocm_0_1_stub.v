...
//               a:/COMP_ARCH/PYNQ_Projects/Vivado_prj/poll_OCM/poll_OCM.srcs/sources_1/bd/design_1/ip/design_1_poll_ocm_0_1/design_1_poll_ocm_0_1_stub.v
...
module design_1_poll_ocm_0_1(s_axi_AXILiteS_AWADDR, 
  s_axi_AXILiteS_AWVALID, s_axi_AXILiteS_AWREADY, s_axi_AXILiteS_WDATA, 
  s_axi_AXILiteS_WSTRB, s_axi_AXILiteS_WVALID, s_axi_AXILiteS_WREADY, 
  s_axi_AXILiteS_BRESP, s_axi_AXILiteS_BVALID, s_axi_AXILiteS_BREADY, 
  s_axi_AXILiteS_ARADDR, s_axi_AXILiteS_ARVALID, s_axi_AXILiteS_ARREADY, 
  s_axi_AXILiteS_RDATA, s_axi_AXILiteS_RRESP, s_axi_AXILiteS_RVALID, 
  s_axi_AXILiteS_RREADY, ap_clk, ap_rst_n, interrupt, m_axi_ADDR_BUS_AWADDR, 
  m_axi_ADDR_BUS_AWLEN, m_axi_ADDR_BUS_AWSIZE, m_axi_ADDR_BUS_AWBURST, 
  m_axi_ADDR_BUS_AWLOCK, m_axi_ADDR_BUS_AWREGION, m_axi_ADDR_BUS_AWCACHE, 
  m_axi_ADDR_BUS_AWPROT, m_axi_ADDR_BUS_AWQOS, m_axi_ADDR_BUS_AWVALID, 
  m_axi_ADDR_BUS_AWREADY, m_axi_ADDR_BUS_WDATA, m_axi_ADDR_BUS_WSTRB, 
  m_axi_ADDR_BUS_WLAST, m_axi_ADDR_BUS_WVALID, m_axi_ADDR_BUS_WREADY, 
  m_axi_ADDR_BUS_BRESP, m_axi_ADDR_BUS_BVALID, m_axi_ADDR_BUS_BREADY, 
  m_axi_ADDR_BUS_ARADDR, m_axi_ADDR_BUS_ARLEN, m_axi_ADDR_BUS_ARSIZE, 
  m_axi_ADDR_BUS_ARBURST, m_axi_ADDR_BUS_ARLOCK, m_axi_ADDR_BUS_ARREGION, 
  m_axi_ADDR_BUS_ARCACHE, m_axi_ADDR_BUS_ARPROT, m_axi_ADDR_BUS_ARQOS, 
  m_axi_ADDR_BUS_ARVALID, m_axi_ADDR_BUS_ARREADY, m_axi_ADDR_BUS_RDATA, 
  m_axi_ADDR_BUS_RRESP, m_axi_ADDR_BUS_RLAST, m_axi_ADDR_BUS_RVALID, 
  m_axi_ADDR_BUS_RREADY, m_axi_DATA_BUS_AWADDR, m_axi_DATA_BUS_AWLEN, 
  m_axi_DATA_BUS_AWSIZE, m_axi_DATA_BUS_AWBURST, m_axi_DATA_BUS_AWLOCK, 
  m_axi_DATA_BUS_AWREGION, m_axi_DATA_BUS_AWCACHE, m_axi_DATA_BUS_AWPROT, 
  m_axi_DATA_BUS_AWQOS, m_axi_DATA_BUS_AWVALID, m_axi_DATA_BUS_AWREADY, 
  m_axi_DATA_BUS_WDATA, m_axi_DATA_BUS_WSTRB, m_axi_DATA_BUS_WLAST, 
  m_axi_DATA_BUS_WVALID, m_axi_DATA_BUS_WREADY, m_axi_DATA_BUS_BRESP, 
  m_axi_DATA_BUS_BVALID, m_axi_DATA_BUS_BREADY, m_axi_DATA_BUS_ARADDR, 
  m_axi_DATA_BUS_ARLEN, m_axi_DATA_BUS_ARSIZE, m_axi_DATA_BUS_ARBURST, 
  m_axi_DATA_BUS_ARLOCK, m_axi_DATA_BUS_ARREGION, m_axi_DATA_BUS_ARCACHE, 
  m_axi_DATA_BUS_ARPROT, m_axi_DATA_BUS_ARQOS, m_axi_DATA_BUS_ARVALID, 
  m_axi_DATA_BUS_ARREADY, m_axi_DATA_BUS_RDATA, m_axi_DATA_BUS_RRESP, 
  m_axi_DATA_BUS_RLAST, m_axi_DATA_BUS_RVALID, m_axi_DATA_BUS_RREADY)
