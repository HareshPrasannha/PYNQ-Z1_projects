...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/skipList_prefetch_N_elem/skipList_prefetch_N_elem.runs/design_1_skipprefetch_Nelem_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_skipprefetch_Nelem_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_skipprefetch_Nelem_0_0.tcl
