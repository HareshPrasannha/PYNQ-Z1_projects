...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/write_ACP/write_ACP.runs/design_1_add_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_add_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_add_0_1.tcl
