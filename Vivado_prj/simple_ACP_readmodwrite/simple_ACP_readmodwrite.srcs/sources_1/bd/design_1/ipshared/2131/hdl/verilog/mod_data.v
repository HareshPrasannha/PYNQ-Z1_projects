...
(* CORE_GENERATION_INFO="mod_data,hls_ip_2016_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=9,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=691,HLS_SYN_LUT=787}" *)
...
reg   [31:0] A_BUS_addr_read_reg_102;
wire   [31:0] tmp_fu_76_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state9) & ~(A_BUS_RVALID == 1'b0))) begin
        A_BUS_addr_read_reg_102 <= A_BUS_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_CS_fsm_state1 == 1'b1) & ~(ap_start == 1'b0))) begin
        a1_reg_91 <= {{a[ap_const_lv32_1F : ap_const_lv32_2]}};
    end
end
...
assign ap_return = (A_BUS_addr_read_reg_102 + ap_const_lv32_63);

always @ (*) begin
    ap_rst_n_inv = ~ap_rst_n;
end

assign tmp_fu_76_p1 = a1_reg_91;
