...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/simple_ACP_readmodwrite/simple_ACP_readmodwrite.runs/design_1_xlconstant_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xlconstant_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xlconstant_0_3.tcl
