...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/simple_ACP_agrs64k_stp16/simple_ACP_agrs64k_stp16.runs/design_1_xlconstant_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xlconstant_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xlconstant_0_2.tcl
