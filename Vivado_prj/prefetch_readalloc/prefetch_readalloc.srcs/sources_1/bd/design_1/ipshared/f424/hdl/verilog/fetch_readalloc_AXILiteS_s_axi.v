...
`timescale 1ns/1ps
module fetch_readalloc_AXILiteS_s_axi
#(parameter
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_LOG_DATA_0)
            int_log[31:0] <= (WDATA[31:0] & wmask) | (int_log[31:0] & ~wmask);
    end
end
