...
CONFIG.NUM_SI {2} \
  ...
  # Create instance: fetch_readalloc_0, and set properties
  set fetch_readalloc_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:fetch_readalloc:1.0 fetch_readalloc_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /fetch_readalloc_0/s_axi_AXILiteS]
...
CONFIG.CONST_WIDTH {4} \
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M01_AXI [get_bd_intf_pins axi_mem_intercon/M01_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP3]
  connect_bd_intf_net -intf_net fetch_readalloc_0_m_axi_A_BUS [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins fetch_readalloc_0/m_axi_A_BUS]
  connect_bd_intf_net -intf_net fetch_readalloc_0_m_axi_LOG_BUS [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins fetch_readalloc_0/m_axi_LOG_BUS]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins fetch_readalloc_0/s_axi_AXILiteS] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins fetch_readalloc_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP3_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins fetch_readalloc_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins processing_system7_0/S_AXI_ACP_ARUSER] [get_bd_pins processing_system7_0/S_AXI_ACP_AWUSER] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins processing_system7_0/S_AXI_ACP_ARCACHE] [get_bd_pins processing_system7_0/S_AXI_ACP_AWCACHE] [get_bd_pins xlconstant_1/dout]

  # Create address segments
  create_bd_addr_seg -range 0x10000000 -offset 0x00000000 [get_bd_addr_spaces fetch_readalloc_0/Data_m_axi_A_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces fetch_readalloc_0/Data_m_axi_A_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP] SEG_processing_system7_0_ACP_IOP
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces fetch_readalloc_0/Data_m_axi_A_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0] SEG_processing_system7_0_ACP_M_AXI_GP0
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces fetch_readalloc_0/Data_m_axi_A_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_processing_system7_0_ACP_QSPI_LINEAR
  create_bd_addr_seg -range 0x00020000 -offset 0xFFFC0000 [get_bd_addr_spaces fetch_readalloc_0/Data_m_axi_LOG_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_HP3/HP3_HIGH_OCM] SEG_processing_system7_0_HP3_HIGH_OCM
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fetch_readalloc_0/s_axi_AXILiteS/Reg] SEG_fetch_readalloc_0_Reg

  # Exclude Address Segments
  create_bd_addr_seg -range 0x00020000 -offset 0xFFFE0000 [get_bd_addr_spaces fetch_readalloc_0/Data_m_axi_A_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_HP3/HP3_HIGH_OCM] SEG_processing_system7_0_HP3_HIGH_OCM
  exclude_bd_addr_seg [get_bd_addr_segs fetch_readalloc_0/Data_m_axi_A_BUS/SEG_processing_system7_0_HP3_HIGH_OCM]

  create_bd_addr_seg -range 0x10000000 -offset 0x00000000 [get_bd_addr_spaces fetch_readalloc_0/Data_m_axi_LOG_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  exclude_bd_addr_seg [get_bd_addr_segs fetch_readalloc_0/Data_m_axi_LOG_BUS/SEG_processing_system7_0_ACP_DDR_LOWOCM]

  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces fetch_readalloc_0/Data_m_axi_LOG_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP] SEG_processing_system7_0_ACP_IOP
  exclude_bd_addr_seg [get_bd_addr_segs fetch_readalloc_0/Data_m_axi_LOG_BUS/SEG_processing_system7_0_ACP_IOP]

  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces fetch_readalloc_0/Data_m_axi_LOG_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0] SEG_processing_system7_0_ACP_M_AXI_GP0
  exclude_bd_addr_seg [get_bd_addr_segs fetch_readalloc_0/Data_m_axi_LOG_BUS/SEG_processing_system7_0_ACP_M_AXI_GP0]

  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces fetch_readalloc_0/Data_m_axi_LOG_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_processing_system7_0_ACP_QSPI_LINEAR
  exclude_bd_addr_seg [get_bd_addr_segs fetch_readalloc_0/Data_m_axi_LOG_BUS/SEG_processing_system7_0_ACP_QSPI_LINEAR]
...
preplace inst fetch_readalloc_0 -pg 1 -lvl 3 -y 150 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 4 -y 520 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 4 -y 440 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 130 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -y 240 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y 230 -defaultsOSRD
...
preplace netloc xlconstant_1_dout 1 4 1 1290
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 340 10 NJ 10 NJ 10 NJ 10 1770
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 3 370 270 650 270 1020
preplace netloc fetch_readalloc_0_m_axi_A_BUS 1 3 1 N
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 10 140 360J 250 630J 70 NJ 70 NJ 70 1760
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 N
preplace netloc xlconstant_0_dout 1 4 1 1300
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 570 340 570 640 570 1000 570 1310 570 1750
preplace netloc fetch_readalloc_0_m_axi_LOG_BUS 1 3 1 N
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 3 350 260 NJ 260 1010J
levelinfo -pg 1 -10 180 500 830 1150 1530 1790 -top 0 -bot 610
",
}
