...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/prefetcher_ACP/prefetcher_ACP.runs/design_1_prefetch_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_prefetch_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_prefetch_0_0.tcl
