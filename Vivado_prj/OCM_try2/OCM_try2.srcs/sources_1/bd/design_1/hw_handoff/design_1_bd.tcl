...
CONFIG.NUM_MI {2} \
  ...
  # Create instance: read_ocm_0, and set properties
  set read_ocm_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:read_ocm:1.0 read_ocm_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /read_ocm_0/s_axi_AXILiteS]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /read_ocm_0/s_axi_CTRL_BUS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins read_ocm_0/s_axi_AXILiteS]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins read_ocm_0/s_axi_CTRL_BUS]
  connect_bd_intf_net -intf_net read_ocm_0_m_axi_SOURCE_BUS [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins read_ocm_0/m_axi_SOURCE_BUS]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins read_ocm_0/ap_clk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins read_ocm_0/ap_rst_n] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs read_ocm_0/s_axi_AXILiteS/Reg] SEG_read_ocm_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs read_ocm_0/s_axi_CTRL_BUS/Reg] SEG_read_ocm_0_Reg1
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces read_ocm_0/Data_m_axi_SOURCE_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces read_ocm_0/Data_m_axi_SOURCE_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP] SEG_processing_system7_0_ACP_IOP
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces read_ocm_0/Data_m_axi_SOURCE_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0] SEG_processing_system7_0_ACP_M_AXI_GP0
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces read_ocm_0/Data_m_axi_SOURCE_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_processing_system7_0_ACP_QSPI_LINEAR
...
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 370 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -y 350 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y 220 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -y 110 -defaultsOSRD
preplace inst read_ocm_0 -pg 1 -lvl 3 -y 390 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 5 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 380 10 NJ 10 NJ 10 NJ 10 1710
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 3 370 230 640 230 1040
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 130 NJ 130 NJ 130 NJ 130 1330J 210 1700
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1320
preplace netloc read_ocm_0_m_axi_SOURCE_BUS 1 3 1 1030
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 N
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 30 510 360 510 650 510 1050 510 1340 510 1710
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 3 350 520 NJ 520 1060
levelinfo -pg 1 0 190 510 840 1190 1520 1730 -top 0 -bot 530
",
}
