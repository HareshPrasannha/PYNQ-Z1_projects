...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/prefetch_with-log/prefetch_with-log.runs/design_1_s00_mmu_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_s00_mmu_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_s00_mmu_0.tcl
