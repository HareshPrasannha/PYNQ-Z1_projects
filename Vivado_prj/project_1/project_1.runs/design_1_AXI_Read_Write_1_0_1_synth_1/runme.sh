...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/project_1/project_1.runs/design_1_AXI_Read_Write_1_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_Read_Write_1_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_Read_Write_1_0_1.tcl
