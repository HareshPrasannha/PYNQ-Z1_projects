...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/Prefetch_master_slave/Prefetch_master_slave.runs/design_1_Prefetch_M_S_IP_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Prefetch_M_S_IP_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Prefetch_M_S_IP_0_1.tcl
