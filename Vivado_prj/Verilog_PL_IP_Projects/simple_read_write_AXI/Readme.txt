...
3. The key aspect of this design is that after the master sends each address value with
   unique ARID's to the slave and waits for the slave to acknowledge it with ARREADY signal with the idea
