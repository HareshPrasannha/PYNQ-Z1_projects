...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/Verilog_PL_IP_Projects/AXI_write_Data/AXI_write_Data.runs/design_1_AXI_write_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_write_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_write_0_0.tcl
