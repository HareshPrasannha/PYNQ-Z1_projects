...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/AXI_master_slave_try2/AXI_master_slave_try2.runs/design_1_master_slave_IP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_master_slave_IP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_master_slave_IP_0_0.tcl
