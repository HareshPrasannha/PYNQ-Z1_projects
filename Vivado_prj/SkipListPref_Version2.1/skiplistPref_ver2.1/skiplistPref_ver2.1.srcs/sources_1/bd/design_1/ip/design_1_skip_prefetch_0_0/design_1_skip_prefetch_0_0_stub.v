...
//               a:/COMP_ARCH/PYNQ_Projects/Vivado_prj/SkipListPref_Version2.1/skiplistPref_ver2.1/skiplistPref_ver2.1.srcs/sources_1/bd/design_1/ip/design_1_skip_prefetch_0_0/design_1_skip_prefetch_0_0_stub.v
...
module design_1_skip_prefetch_0_0(s_axi_CFG_AWADDR, s_axi_CFG_AWVALID, 
  ...
  m_axi_PREF_WINDOW_AWADDR, m_axi_PREF_WINDOW_AWLEN, m_axi_PREF_WINDOW_AWSIZE, 
  m_axi_PREF_WINDOW_AWBURST, m_axi_PREF_WINDOW_AWLOCK, m_axi_PREF_WINDOW_AWREGION, 
  m_axi_PREF_WINDOW_AWCACHE, m_axi_PREF_WINDOW_AWPROT, m_axi_PREF_WINDOW_AWQOS, 
  m_axi_PREF_WINDOW_AWVALID, m_axi_PREF_WINDOW_AWREADY, m_axi_PREF_WINDOW_WDATA, 
  m_axi_PREF_WINDOW_WSTRB, m_axi_PREF_WINDOW_WLAST, m_axi_PREF_WINDOW_WVALID, 
  m_axi_PREF_WINDOW_WREADY, m_axi_PREF_WINDOW_BRESP, m_axi_PREF_WINDOW_BVALID, 
  m_axi_PREF_WINDOW_BREADY, m_axi_PREF_WINDOW_ARADDR, m_axi_PREF_WINDOW_ARLEN, 
  m_axi_PREF_WINDOW_ARSIZE, m_axi_PREF_WINDOW_ARBURST, m_axi_PREF_WINDOW_ARLOCK, 
  m_axi_PREF_WINDOW_ARREGION, m_axi_PREF_WINDOW_ARCACHE, m_axi_PREF_WINDOW_ARPROT, 
  m_axi_PREF_WINDOW_ARQOS, m_axi_PREF_WINDOW_ARVALID, m_axi_PREF_WINDOW_ARREADY, 
  m_axi_PREF_WINDOW_RDATA, m_axi_PREF_WINDOW_RRESP, m_axi_PREF_WINDOW_RLAST, 
  m_axi_PREF_WINDOW_RVALID, m_axi_PREF_WINDOW_RREADY)
/* synthesis syn_black_box black_box_pad_pin="s_axi_CFG_AWADDR[4:0],s_axi_CFG_AWVALID,s_axi_CFG_AWREADY,s_axi_CFG_WDATA[31:0],s_axi_CFG_WSTRB[3:0],s_axi_CFG_WVALID,s_axi_CFG_WREADY,s_axi_CFG_BRESP[1:0],s_axi_CFG_BVALID,s_axi_CFG_BREADY,s_axi_CFG_ARADDR[4:0],s_axi_CFG_ARVALID,s_axi_CFG_ARREADY,s_axi_CFG_RDATA[31:0],s_axi_CFG_RRESP[1:0],s_axi_CFG_RVALID,s_axi_CFG_RREADY,ap_clk,ap_rst_n,interrupt,m_axi_A_BUS_AWADDR[31:0],m_axi_A_BUS_AWLEN[7:0],m_axi_A_BUS_AWSIZE[2:0],m_axi_A_BUS_AWBURST[1:0],m_axi_A_BUS_AWLOCK[1:0],m_axi_A_BUS_AWREGION[3:0],m_axi_A_BUS_AWCACHE[3:0],m_axi_A_BUS_AWPROT[2:0],m_axi_A_BUS_AWQOS[3:0],m_axi_A_BUS_AWVALID,m_axi_A_BUS_AWREADY,m_axi_A_BUS_WDATA[63:0],m_axi_A_BUS_WSTRB[7:0],m_axi_A_BUS_WLAST,m_axi_A_BUS_WVALID,m_axi_A_BUS_WREADY,m_axi_A_BUS_BRESP[1:0],m_axi_A_BUS_BVALID,m_axi_A_BUS_BREADY,m_axi_A_BUS_ARADDR[31:0],m_axi_A_BUS_ARLEN[7:0],m_axi_A_BUS_ARSIZE[2:0],m_axi_A_BUS_ARBURST[1:0],m_axi_A_BUS_ARLOCK[1:0],m_axi_A_BUS_ARREGION[3:0],m_axi_A_BUS_ARCACHE[3:0],m_axi_A_BUS_ARPROT[2:0],m_axi_A_BUS_ARQOS[3:0],m_axi_A_BUS_ARVALID,m_axi_A_BUS_ARREADY,m_axi_A_BUS_RDATA[63:0],m_axi_A_BUS_RRESP[1:0],m_axi_A_BUS_RLAST,m_axi_A_BUS_RVALID,m_axi_A_BUS_RREADY,m_axi_PREF_WINDOW_AWADDR[31:0],m_axi_PREF_WINDOW_AWLEN[7:0],m_axi_PREF_WINDOW_AWSIZE[2:0],m_axi_PREF_WINDOW_AWBURST[1:0],m_axi_PREF_WINDOW_AWLOCK[1:0],m_axi_PREF_WINDOW_AWREGION[3:0],m_axi_PREF_WINDOW_AWCACHE[3:0],m_axi_PREF_WINDOW_AWPROT[2:0],m_axi_PREF_WINDOW_AWQOS[3:0],m_axi_PREF_WINDOW_AWVALID,m_axi_PREF_WINDOW_AWREADY,m_axi_PREF_WINDOW_WDATA[31:0],m_axi_PREF_WINDOW_WSTRB[3:0],m_axi_PREF_WINDOW_WLAST,m_axi_PREF_WINDOW_WVALID,m_axi_PREF_WINDOW_WREADY,m_axi_PREF_WINDOW_BRESP[1:0],m_axi_PREF_WINDOW_BVALID,m_axi_PREF_WINDOW_BREADY,m_axi_PREF_WINDOW_ARADDR[31:0],m_axi_PREF_WINDOW_ARLEN[7:0],m_axi_PREF_WINDOW_ARSIZE[2:0],m_axi_PREF_WINDOW_ARBURST[1:0],m_axi_PREF_WINDOW_ARLOCK[1:0],m_axi_PREF_WINDOW_ARREGION[3:0],m_axi_PREF_WINDOW_ARCACHE[3:0],m_axi_PREF_WINDOW_ARPROT[2:0],m_axi_PREF_WINDOW_ARQOS[3:0],m_axi_PREF_WINDOW_ARVALID,m_axi_PREF_WINDOW_ARREADY,m_axi_PREF_WINDOW_RDATA[31:0],m_axi_PREF_WINDOW_RRESP[1:0],m_axi_PREF_WINDOW_RLAST,m_axi_PREF_WINDOW_RVALID,m_axi_PREF_WINDOW_RREADY" */;
