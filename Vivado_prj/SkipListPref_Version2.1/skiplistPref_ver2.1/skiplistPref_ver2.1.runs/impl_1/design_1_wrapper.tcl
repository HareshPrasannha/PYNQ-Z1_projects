...
set rc [catch {
  ...
  set_property webtalk.parent_dir A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/SkipListPref_Version2.1/skiplistPref_ver2.1/skiplistPref_ver2.1.cache/wt [current_project]
