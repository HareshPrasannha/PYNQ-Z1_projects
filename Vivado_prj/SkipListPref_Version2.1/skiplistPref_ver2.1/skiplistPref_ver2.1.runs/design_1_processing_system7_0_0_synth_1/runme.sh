...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/SkipListPref_Version2.1/skiplistPref_ver2.1/skiplistPref_ver2.1.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
