...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/Vivado_prj/simple_ACP_agrs64k_stp1/simple_ACP_agrs64k_stp1.runs/design_1_mod_data_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_mod_data_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_mod_data_0_0.tcl
