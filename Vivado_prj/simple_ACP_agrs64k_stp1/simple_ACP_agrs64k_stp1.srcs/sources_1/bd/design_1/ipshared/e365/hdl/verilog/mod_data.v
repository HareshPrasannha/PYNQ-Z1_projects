...
(* CORE_GENERATION_INFO="mod_data,hls_ip_2016_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=1281,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=787,HLS_SYN_LUT=874}" *)
...
parameter    ap_const_lv16_1F3 = 16'b111110011;
parameter    ap_const_lv16_1F4 = 16'b111110100;
...
wire   [30:0] tmp_cast_fu_112_p1;
reg   [30:0] tmp_cast_reg_158;
wire   [30:0] a2_sum_fu_132_p2;
reg   [30:0] a2_sum_reg_166;
wire   [0:0] ap_CS_fsm_state2;
wire   [0:0] exitcond_fu_116_p2;
wire   [15:0] i_1_1_fu_137_p2;
reg   [15:0] i_1_1_reg_171;
reg    ap_sig_ioackin_A_BUS_ARREADY;
reg   [31:0] A_BUS_addr_read_reg_182;
wire   [31:0] phitmp_s_fu_153_p2;
wire   [0:0] ap_CS_fsm_state11;
reg   [31:0] ret_val_reg_80;
reg   [15:0] i_reg_91;
wire   [31:0] a2_sum_cast_fu_143_p1;
reg    ap_reg_ioackin_A_BUS_ARREADY;
wire   [29:0] tmp_fu_102_p4;
wire   [15:0] i_1_s_fu_122_p2;
wire   [30:0] i_1_cast_cast_fu_128_p1;
reg   [10:0] ap_NS_fsm;
wire   [31:0] ap_return;
...
mod_data_A_BUS_m_axi_U(
    ...
    .I_ARADDR(a2_sum_cast_fu_143_p1),
    .I_ARID(1'b0),
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state10) & ~(A_BUS_RVALID == 1'b0))) begin
        A_BUS_addr_read_reg_182 <= A_BUS_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond_fu_116_p2 == 1'b0))) begin
        a2_sum_reg_166 <= a2_sum_fu_132_p2;
        i_1_1_reg_171 <= i_1_1_fu_137_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        ret_val_reg_80 <= phitmp_s_fu_153_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_CS_fsm_state1 == 1'b1) & ~(ap_start == 1'b0))) begin
        tmp_cast_reg_158[29 : 0] <= tmp_cast_fu_112_p1[29 : 0];
    end
end
...
assign a2_sum_cast_fu_143_p1 = a2_sum_reg_166;

assign a2_sum_fu_132_p2 = (i_1_cast_cast_fu_128_p1 + tmp_cast_reg_158);
...
assign exitcond_fu_116_p2 = ((i_reg_91 == ap_const_lv16_FA00) ? 1'b1 : 1'b0);

assign i_1_1_fu_137_p2 = (i_reg_91 + ap_const_lv16_1F4);

assign i_1_cast_cast_fu_128_p1 = i_1_s_fu_122_p2;

assign i_1_s_fu_122_p2 = (i_reg_91 + ap_const_lv16_1F3);

assign phitmp_s_fu_153_p2 = (A_BUS_addr_read_reg_182 + ap_const_lv32_63);

assign tmp_cast_fu_112_p1 = tmp_fu_102_p4;

assign tmp_fu_102_p4 = {{a[ap_const_lv32_1F : ap_const_lv32_2]}};

always @ (posedge ap_clk) begin
    tmp_cast_reg_158[30] <= 1'b0;
end
