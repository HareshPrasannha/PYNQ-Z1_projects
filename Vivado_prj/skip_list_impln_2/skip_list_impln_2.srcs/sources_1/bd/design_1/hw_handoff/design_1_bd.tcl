...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: skip_list_prefetch_0, and set properties
  set skip_list_prefetch_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:skip_list_prefetch:1.0 skip_list_prefetch_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /skip_list_prefetch_0/s_axi_CFG]
...
CONFIG.CONST_WIDTH {4} \
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins skip_list_prefetch_0/ap_rst_n]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs skip_list_prefetch_0/s_axi_CFG/Reg] SEG_skip_list_prefetch_0_Reg
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces skip_list_prefetch_0/Data_m_axi_A_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_DDR_LOWOCM] SEG_processing_system7_0_ACP_DDR_LOWOCM
  create_bd_addr_seg -range 0x00400000 -offset 0xE0000000 [get_bd_addr_spaces skip_list_prefetch_0/Data_m_axi_A_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_IOP] SEG_processing_system7_0_ACP_IOP
  create_bd_addr_seg -range 0x40000000 -offset 0x40000000 [get_bd_addr_spaces skip_list_prefetch_0/Data_m_axi_A_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_M_AXI_GP0] SEG_processing_system7_0_ACP_M_AXI_GP0
  create_bd_addr_seg -range 0x01000000 -offset 0xFC000000 [get_bd_addr_spaces skip_list_prefetch_0/Data_m_axi_A_BUS] [get_bd_addr_segs processing_system7_0/S_AXI_ACP/ACP_QSPI_LINEAR] SEG_processing_system7_0_ACP_QSPI_LINEAR
...
preplace inst skip_list_prefetch_0 -pg 1 -lvl 3 -y 500 -defaultsOSRD
...
preplace netloc skip_list_prefetch_0_m_axi_A_BUS 1 3 1 960
