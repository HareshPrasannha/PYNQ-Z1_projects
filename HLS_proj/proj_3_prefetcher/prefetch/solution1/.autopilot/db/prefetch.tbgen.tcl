set C_TypeInfoList {{ 
"prefetch" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"source": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
set moduleName prefetch
...
set C_modelName {prefetch}
set C_modelType { int 32 }
set C_modelArgList {
	{ SOURCE_BUS int 32 regular {axi_master 0}  }
	{ source int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "SOURCE_BUS", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "source","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "source","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"prefetch","role":"start","value":"0","valid_bit":"0"},{"name":"prefetch","role":"continue","value":"0","valid_bit":"4"},{"name":"prefetch","role":"auto_start","value":"0","valid_bit":"7"},{"name":"source","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"prefetch","role":"start","value":"0","valid_bit":"0"},{"name":"prefetch","role":"done","value":"0","valid_bit":"1"},{"name":"prefetch","role":"idle","value":"0","valid_bit":"2"},{"name":"prefetch","role":"ready","value":"0","valid_bit":"3"},{"name":"prefetch","role":"auto_start","value":"0","valid_bit":"7"},{"name":"return","role":"data","value":"16"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"ControlExist" : "1",
		"Port" : [
		{"Name" : "SOURCE_BUS", "Type" : "MAXI", "Direction" : "I",
			"BlockSignal" : [
			{"Name" : "SOURCE_BUS_blk_n_AR", "Type" : "RtlSignal"},
			{"Name" : "SOURCE_BUS_blk_n_R", "Type" : "RtlSignal"}]},
		{"Name" : "source", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.prefetch_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.prefetch_SOURCE_BUS_m_axi_U", "Parent" : "0"}]}
