...
set IPName      "prefetch"
set Version     "1.0"
set DisplayName "Prefetch"
set Revision    "2003261608"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_SOURCE_BUS"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 18 II x}
...
set enable_xo_gen 0
set kernel_files {A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_3_prefetcher/prefetch.cpp}
if {$enable_xo_gen} {
