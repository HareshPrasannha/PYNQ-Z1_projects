...
if {[file isfile prefetch.autotvin.dat]} {
	file delete -force prefetch.autotvin.dat
}

if {[file isfile prefetch.autotvout.dat]} {
	file delete -force prefetch.autotvout.dat
}
