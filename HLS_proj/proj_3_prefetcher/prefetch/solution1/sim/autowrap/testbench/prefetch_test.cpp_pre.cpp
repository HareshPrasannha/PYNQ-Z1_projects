# 1 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_3_prefetcher/prefetch_test.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_3_prefetcher/prefetch_test.cpp"
...
# 4 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_3_prefetcher/prefetch_test.cpp" 2
...
int main()
{
 ...
 for (int i =0;i<10;i++)
  a[i] = i;
# 37 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_3_prefetcher/prefetch_test.cpp"
 int status = prefetch(a);
 if(status == 1)
  printf("Done\n");
 else
  printf("Failed\n");
# 57 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_3_prefetcher/prefetch_test.cpp"
 return 0;
}
