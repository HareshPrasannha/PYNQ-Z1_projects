...
$(ObjDir)/prefetch_test.cpp_pre.cpp.tb.o : prefetch_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling prefetch_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/prefetch.cpp_pre.cpp.tb.o : prefetch.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling prefetch.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
