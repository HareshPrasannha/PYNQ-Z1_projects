...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "prefetch.autotvin.dat"
	set constFileTvOut       "prefetch.autotvout.dat"
	set constFileHdlTvIn     "prefetch.autohdltvin.dat"
	set constFileHdlTvOut    "prefetch.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
