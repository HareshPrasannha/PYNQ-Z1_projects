#pragma line 1 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_13_skiplist_prefetch/skip_list_prefetch_test.cpp"
...
#pragma line 2 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_13_skiplist_prefetch/skip_list_prefetch_test.cpp" 2
...
#pragma line 3 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_13_skiplist_prefetch/skip_list_prefetch_test.cpp" 2
const int n = 20;
...
int main()
{
 ...
 for(int i=0;i<n;i++){
  ...
  if(head == __null){
   ...
   prevnode->offset[0] = (newnode - prevnode);
  }
  if((i+1)%skip_intr == 0){
   skip_prevnode->offset[1] = (newnode - skip_prevnode);
   skip_prevnode = newnode;
  }
  prevnode = newnode;
 }
...
#pragma empty_line
 printf("\n\n");
  ...
  printf("Val: %d-->",temp->val);
   ...
   temp = old_temp+old_temp->offset[1];
   printf("next_val_2: %d  ",temp->val);
  temp = old_temp+old_temp->offset[0];
  printf("\n");
        }
 return 0;
}
