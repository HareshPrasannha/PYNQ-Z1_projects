...
if {[file isfile skip_list_prefetch.autotvin.dat]} {
	file delete -force skip_list_prefetch.autotvin.dat
}

if {[file isfile skip_list_prefetch.autotvout.dat]} {
	file delete -force skip_list_prefetch.autotvout.dat
}
