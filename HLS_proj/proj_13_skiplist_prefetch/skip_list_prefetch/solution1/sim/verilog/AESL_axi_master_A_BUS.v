...
//------------------------Parameter----------------------
`define TV_IN_A_BUS "../tv/cdatafile/c.skip_list_prefetch.autotvin_A_BUS.dat"
`define TV_OUT_A_BUS "../tv/rtldatafile/rtl.skip_list_prefetch.autotvout_A_BUS.dat"
 parameter A_BUS_ADDR_BITWIDTH = 32'd 32;
 parameter A_BUS_AWUSER_BITWIDTH = 32'd 1;
 parameter A_BUS_DATA_BITWIDTH = 32'd 32;
...
parameter A_BUS_C_DATA_BITWIDTH = 32'd 32;
parameter A_BUS_mem_depth = 32'd 3;
...
output [32 - 1 : 0] TRAN_A_BUS_a_val;
output [32 - 1 : 0] TRAN_A_BUS_a_offset;
input ready;
input done;
...
assign    TRAN_A_BUS_a_val = a_val;
assign    TRAN_A_BUS_a_offset = a_offset;
...
initial begin : initialize_offset
  ...
  a_val <= 0 * DATA_byte_num;
  a_offset <= 1 * DATA_byte_num;
end
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > A_BUS_mem_depth) begin
                $display ("A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_13_skiplist_prefetch/skip_list_prefetch/solution1/sim/verilog/AESL_axi_master_A_BUS.v: Write request address %d exceed AXI master A_BUS array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, A_BUS_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > A_BUS_mem_depth) begin
                $display ("A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_13_skiplist_prefetch/skip_list_prefetch/solution1/sim/verilog/AESL_axi_master_A_BUS.v: Read request address %d exceed AXI master A_BUS array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, A_BUS_mem_depth); 
                $finish;
            end
