...
`timescale 1ns/1ps
module skip_list_prefetch_CFG_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER             = 5'h08,
    ADDR_ISR             = 5'h0c,
    ADDR_A_VAL_DATA_0    = 5'h10,
    ADDR_A_VAL_CTRL      = 5'h14,
    ADDR_A_OFFSET_DATA_0 = 5'h18,
    ADDR_A_OFFSET_CTRL   = 5'h1c,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    RDIDLE               = 2'd0,
