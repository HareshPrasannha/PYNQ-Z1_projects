...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.skip_list_prefetch.autotvin_A_BUS.dat"
         "c.skip_list_prefetch.autotvin_a_val.dat"
         "c.skip_list_prefetch.autotvin_a_offset.dat"
         "c.skip_list_prefetch.autotvout_A_BUS.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.skip_list_prefetch.autotvout_A_BUS.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
