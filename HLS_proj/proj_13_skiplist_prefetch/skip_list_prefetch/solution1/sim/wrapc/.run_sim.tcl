...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "skip_list_prefetch.autotvin.dat"
	set constFileTvOut       "skip_list_prefetch.autotvout.dat"
	set constFileHdlTvIn     "skip_list_prefetch.autohdltvin.dat"
	set constFileHdlTvOut    "skip_list_prefetch.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
