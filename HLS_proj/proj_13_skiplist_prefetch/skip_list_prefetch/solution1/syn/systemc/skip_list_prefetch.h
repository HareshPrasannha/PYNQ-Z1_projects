...
struct skip_list_prefetch : public sc_module {
    ...
    sc_signal< sc_lv<9> > i_reg_131;
    sc_signal< sc_lv<9> > ap_pipeline_reg_pp0_iter1_i_reg_131;
    sc_signal< sc_lv<25> > cum_offs_reg_143;
    sc_signal< sc_lv<14> > indvar_flatten_reg_155;
    sc_signal< sc_lv<9> > i1_reg_166;
    ...
    sc_signal< sc_lv<9> > i_1_fu_224_p2;
    sc_signal< sc_lv<9> > i_1_reg_368;
    sc_signal< sc_lv<32> > A_BUS_addr_1_reg_373;
    sc_signal< sc_lv<25> > cum_offs_1_fu_275_p2;
    ...
    sc_signal< sc_lv<9> > buff_addr_1_reg_404;
    sc_signal< sc_lv<9> > ap_pipeline_reg_pp1_iter1_buff_addr_1_reg_404;
    sc_signal< sc_lv<9> > ap_pipeline_reg_pp1_iter2_buff_addr_1_reg_404;
    sc_signal< sc_lv<9> > ap_pipeline_reg_pp1_iter3_buff_addr_1_reg_404;
    sc_signal< sc_lv<9> > ap_pipeline_reg_pp1_iter4_buff_addr_1_reg_404;
    sc_signal< sc_lv<9> > ap_pipeline_reg_pp1_iter5_buff_addr_1_reg_404;
    sc_signal< sc_lv<9> > ap_pipeline_reg_pp1_iter6_buff_addr_1_reg_404;
    sc_signal< sc_lv<9> > ap_pipeline_reg_pp1_iter7_buff_addr_1_reg_404;
    sc_signal< sc_lv<9> > ap_pipeline_reg_pp1_iter8_buff_addr_1_reg_404;
    sc_signal< sc_lv<9> > ap_pipeline_reg_pp1_iter9_buff_addr_1_reg_404;
    sc_signal< sc_lv<9> > i_2_fu_322_p2;
    ...
    sc_signal< sc_lv<9> > i_phi_fu_135_p4;
    sc_signal< sc_lv<25> > cum_offs_phi_fu_147_p4;
    ...
    sc_signal< sc_lv<25> > tmp_cast_fu_246_p1;
    sc_signal< sc_lv<25> > tmp_1_fu_250_p2;
    sc_signal< sc_lv<16> > tmp_5_fu_261_p4;
    sc_signal< sc_lv<25> > tmp_2_cast_fu_271_p1;
    sc_signal< sc_lv<1> > exitcond5_fu_303_p2;
    sc_signal< sc_lv<9> > i1_mid2_fu_309_p3;
    ...
    static const sc_lv<14> ap_const_lv14_2509;
