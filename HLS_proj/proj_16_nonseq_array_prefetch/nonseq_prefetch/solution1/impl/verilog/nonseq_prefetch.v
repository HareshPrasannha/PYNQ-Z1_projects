...
(* CORE_GENERATION_INFO="nonseq_prefetch,hls_ip_2016_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=509,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=691,HLS_SYN_LUT=786}" *)
...
reg   [0:0] ap_pipeline_reg_pp0_iter7_exitcond_reg_182;
wire    A_BUS_AWREADY;
wire    A_BUS_WREADY;
reg    A_BUS_ARVALID;
wire    A_BUS_ARREADY;
...
reg   [8:0] k_reg_92;
reg   [20:0] i_reg_103;
wire   [30:0] tmp_2_cast_fu_124_p1;
reg   [30:0] tmp_2_cast_reg_177;
wire   [0:0] exitcond_fu_128_p2;
reg    ap_sig_ioackin_A_BUS_ARREADY;
reg   [0:0] ap_pipeline_reg_pp0_iter1_exitcond_reg_182;
reg   [0:0] ap_pipeline_reg_pp0_iter2_exitcond_reg_182;
reg   [0:0] ap_pipeline_reg_pp0_iter3_exitcond_reg_182;
reg   [0:0] ap_pipeline_reg_pp0_iter4_exitcond_reg_182;
reg   [0:0] ap_pipeline_reg_pp0_iter5_exitcond_reg_182;
reg   [0:0] ap_pipeline_reg_pp0_iter6_exitcond_reg_182;
wire   [30:0] a2_sum_fu_138_p2;
reg   [30:0] a2_sum_reg_186;
wire   [20:0] i_1_fu_155_p2;
...
wire   [31:0] a2_sum_cast_fu_167_p1;
reg    ap_reg_ioackin_A_BUS_ARREADY;
wire   [29:0] tmp_2_fu_114_p4;
wire   [30:0] i_cast_cast_fu_134_p1;
wire   [11:0] tmp_fu_143_p3;
wire   [20:0] tmp_cast_fu_151_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & ~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0))) & ~(1'b0 == exitcond_fu_128_p2))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        end else if ((((ap_CS_fsm_state1 == 1'b1) & ~(ap_start == 1'b0)) | ((1'b1 == ap_CS_fsm_pp0_stage0) & ~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0))) & ~(1'b0 == exitcond_fu_128_p2)))) begin
            ap_enable_reg_pp0_iter1 <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if (~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0)))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((ap_condition_90 == 1'b1)) begin
            if ((ap_condition_230 == 1'b1)) begin
                ap_reg_ioackin_A_BUS_ARREADY <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & ~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0))) & (1'b0 == exitcond_fu_128_p2) & (1'b1 == ap_enable_reg_pp0_iter0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & ~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0))))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_CS_fsm_state1 == 1'b1) & ~(ap_start == 1'b0))) begin
        tmp_2_cast_reg_177[29 : 0] <= tmp_2_cast_fu_124_p1[29 : 0];
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & ~((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0)) & (1'b0 == ap_reg_ioackin_A_BUS_ARREADY))) begin
        A_BUS_ARVALID = 1'b1;
    end else begin
        A_BUS_ARVALID = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & ~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0))))) begin
        A_BUS_RREADY = 1'b1;
    end else begin
        A_BUS_RREADY = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b1 == ap_enable_reg_pp0_iter8) & ~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0))) & ~(1'b1 == ap_enable_reg_pp0_iter7)) & ~(~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0))) & (1'b1 == ap_enable_reg_pp0_iter0) & ~(1'b0 == exitcond_fu_128_p2) & ~(1'b1 == ap_enable_reg_pp0_iter1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b1 == ap_enable_reg_pp0_iter8) & ~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0))) & ~(1'b1 == ap_enable_reg_pp0_iter7)) | (~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0))) & (1'b1 == ap_enable_reg_pp0_iter0) & ~(1'b0 == exitcond_fu_128_p2) & ~(1'b1 == ap_enable_reg_pp0_iter1)))) begin
...
assign a2_sum_cast_fu_167_p1 = a2_sum_reg_186;

assign a2_sum_fu_138_p2 = (i_cast_cast_fu_134_p1 + tmp_2_cast_reg_177);
...
always @ (*) begin
    ap_condition_230 = ~(((1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0) & (1'b0 == ap_sig_ioackin_A_BUS_ARREADY)) | ((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0)));
end

always @ (*) begin
    ap_condition_358 = ((1'b1 == A_BUS_ARREADY) & ~((1'b1 == ap_enable_reg_pp0_iter8) & (1'b0 == ap_pipeline_reg_pp0_iter7_exitcond_reg_182) & (A_BUS_RVALID == 1'b0)));
end

always @ (*) begin
    ap_condition_90 = ((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_enable_reg_pp0_iter1) & (exitcond_reg_182 == 1'b0));
end
...
assign exitcond_fu_128_p2 = ((k_reg_92 == ap_const_lv9_1F5) ? 1'b1 : 1'b0);

assign i_1_fu_155_p2 = (tmp_cast_fu_151_p1 + i_reg_103);

assign i_cast_cast_fu_134_p1 = i_reg_103;

assign phitmp_fu_161_p2 = (k_reg_92 + ap_const_lv9_1);

assign tmp_2_cast_fu_124_p1 = tmp_2_fu_114_p4;

assign tmp_2_fu_114_p4 = {{a[ap_const_lv32_1F : ap_const_lv32_2]}};

assign tmp_cast_fu_151_p1 = tmp_fu_143_p3;

assign tmp_fu_143_p3 = {{k_reg_92}, {ap_const_lv3_0}};

always @ (posedge ap_clk) begin
    tmp_2_cast_reg_177[30] <= 1'b0;
end

endmodule //nonseq_prefetch
