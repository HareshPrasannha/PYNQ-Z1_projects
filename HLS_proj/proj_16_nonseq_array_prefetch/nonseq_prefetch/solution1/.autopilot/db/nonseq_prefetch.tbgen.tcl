set C_TypeInfoList {{ 
"nonseq_prefetch" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
set moduleName nonseq_prefetch
...
set C_modelName {nonseq_prefetch}
...
set C_modelArgMapList {[ 
	{ "Name" : "A_BUS", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "a","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 999999,"step" : 1}]}]}]} , 
...
set NewPortList {[ 
	{ "name": "s_axi_CFG_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CFG", "role": "AWADDR" },"address":[{"name":"nonseq_prefetch","role":"start","value":"0","valid_bit":"0"},{"name":"nonseq_prefetch","role":"continue","value":"0","valid_bit":"4"},{"name":"nonseq_prefetch","role":"auto_start","value":"0","valid_bit":"7"},{"name":"a","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_CFG_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CFG", "role": "ARADDR" },"address":[{"name":"nonseq_prefetch","role":"start","value":"0","valid_bit":"0"},{"name":"nonseq_prefetch","role":"done","value":"0","valid_bit":"1"},{"name":"nonseq_prefetch","role":"idle","value":"0","valid_bit":"2"},{"name":"nonseq_prefetch","role":"ready","value":"0","valid_bit":"3"},{"name":"nonseq_prefetch","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.nonseq_prefetch_CFG_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.nonseq_prefetch_A_BUS_m_axi_U", "Parent" : "0"}]}
...
set busDeadlockParameterList { 
	{ A_BUS { NUM_READ_OUTSTANDING 32 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 2 MAX_WRITE_BURST_LENGTH 16 } } \
}
