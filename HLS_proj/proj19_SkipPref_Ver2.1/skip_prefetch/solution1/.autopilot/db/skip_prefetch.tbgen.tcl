set C_TypeInfoList {{ 
"skip_prefetch" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[],{ "pointer": "0"}] }, {"n": [[],{ "pointer":  {"scalar": "int"}}] }],[],""], 
"0": [ "node", {"struct": [[],[],[{ "val": [[32], "1"]},{ "offs": [[],  {"array": ["2", [2]]}]}],""]}], 
"1": [ "dat_typ", {"typedef": [[[], {"scalar": "int"}],""]}], 
"2": [ "dat_typ1", {"typedef": [[[], {"scalar": "short"}],""]}]
}}
set moduleName skip_prefetch
...
set C_modelArgMapList {[ 
	{ "Name" : "A_BUS", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a.val","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "a"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]},{"low":32,"up":47,"cElement": [{"cName": "a.offs","cData": "short","bit_use": { "low": 0,"up": 15},"offset": { "type": "dynamic","port_name": "a"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 2}]}]},{"low":48,"up":63,"cElement": [{"cName": "a.offs","cData": "short","bit_use": { "low": 0,"up": 15},"offset": { "type": "dynamic","port_name": "a"},"direction": "READONLY","cArray": [{"low" : 1,"up" : 1,"step" : 2}]}]}]} , 
 	{ "Name" : "PREF_WINDOW", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "n","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "n","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set NewPortList {[ 
	{ "name": "s_axi_CFG_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CFG", "role": "AWADDR" },"address":[{"name":"skip_prefetch","role":"start","value":"0","valid_bit":"0"},{"name":"skip_prefetch","role":"continue","value":"0","valid_bit":"4"},{"name":"skip_prefetch","role":"auto_start","value":"0","valid_bit":"7"},{"name":"a","role":"data","value":"16"},{"name":"n","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_CFG_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CFG", "role": "ARADDR" },"address":[{"name":"skip_prefetch","role":"start","value":"0","valid_bit":"0"},{"name":"skip_prefetch","role":"done","value":"0","valid_bit":"1"},{"name":"skip_prefetch","role":"idle","value":"0","valid_bit":"2"},{"name":"skip_prefetch","role":"ready","value":"0","valid_bit":"3"},{"name":"skip_prefetch","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.skip_prefetch_CFG_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.skip_prefetch_A_BUS_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.skip_prefetch_PREF_WINDOW_m_axi_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.buff_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.skip_prefetch_mulbkb_U0", "Parent" : "0"}]}
