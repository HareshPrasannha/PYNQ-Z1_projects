...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "skip_prefetch.autotvin.dat"
	set constFileTvOut       "skip_prefetch.autotvout.dat"
	set constFileHdlTvIn     "skip_prefetch.autohdltvin.dat"
	set constFileHdlTvOut    "skip_prefetch.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
