...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fetch_readalloc.autotvin_A_BUS.dat"
         "c.fetch_readalloc.autotvin_a.dat"
         "c.fetch_readalloc.autotvin_log.dat"
         "c.fetch_readalloc.autotvout_LOG_BUS.dat"
         "c.fetch_readalloc.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fetch_readalloc.autotvout_LOG_BUS.dat"
         "rtl.fetch_readalloc.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
