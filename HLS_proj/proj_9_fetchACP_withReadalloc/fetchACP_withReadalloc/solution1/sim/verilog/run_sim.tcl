...
if {[file isfile fetch_readalloc.autotvin.dat]} {
	file delete -force fetch_readalloc.autotvin.dat
}

if {[file isfile fetch_readalloc.autotvout.dat]} {
	file delete -force fetch_readalloc.autotvout.dat
}
