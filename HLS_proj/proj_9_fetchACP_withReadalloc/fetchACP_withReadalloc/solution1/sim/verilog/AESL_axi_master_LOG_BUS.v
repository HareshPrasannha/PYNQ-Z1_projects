...
module AESL_axi_master_LOG_BUS (
    clk,
    reset,
    TRAN_LOG_BUS_AWVALID,
    TRAN_LOG_BUS_AWREADY,
    TRAN_LOG_BUS_AWADDR,
    TRAN_LOG_BUS_AWID,
    TRAN_LOG_BUS_AWLEN,
    TRAN_LOG_BUS_AWSIZE,
    TRAN_LOG_BUS_AWBURST,
    TRAN_LOG_BUS_AWLOCK,
    TRAN_LOG_BUS_AWCACHE,
    TRAN_LOG_BUS_AWPROT,
    TRAN_LOG_BUS_AWQOS,
    TRAN_LOG_BUS_AWREGION,
    TRAN_LOG_BUS_AWUSER,
    TRAN_LOG_BUS_WVALID,
    TRAN_LOG_BUS_WREADY,
    TRAN_LOG_BUS_WDATA,
    ...
    TRAN_LOG_BUS_WID,
    TRAN_LOG_BUS_WUSER,
    TRAN_LOG_BUS_ARVALID,
    TRAN_LOG_BUS_ARREADY,
    TRAN_LOG_BUS_ARADDR,
    TRAN_LOG_BUS_ARID,
    TRAN_LOG_BUS_ARLEN,
    TRAN_LOG_BUS_ARSIZE,
    TRAN_LOG_BUS_ARBURST,
    TRAN_LOG_BUS_ARLOCK,
    TRAN_LOG_BUS_ARCACHE,
    TRAN_LOG_BUS_ARPROT,
    TRAN_LOG_BUS_ARQOS,
    TRAN_LOG_BUS_ARREGION,
    TRAN_LOG_BUS_ARUSER,
    TRAN_LOG_BUS_RVALID,
    TRAN_LOG_BUS_RREADY,
    TRAN_LOG_BUS_RDATA,
...
//------------------------Parameter----------------------
`define TV_IN_LOG_BUS "../tv/cdatafile/c.fetch_readalloc.autotvin_LOG_BUS.dat"
`define TV_OUT_LOG_BUS "../tv/rtldatafile/rtl.fetch_readalloc.autotvout_LOG_BUS.dat"
 parameter LOG_BUS_ADDR_BITWIDTH = 32'd 32;
 parameter LOG_BUS_AWUSER_BITWIDTH = 32'd 1;
 parameter LOG_BUS_DATA_BITWIDTH = 32'd 32;
 parameter LOG_BUS_WUSER_BITWIDTH = 32'd 1;
 parameter LOG_BUS_ID_BITWIDTH = 32'd 1;
 parameter LOG_BUS_RUSER_BITWIDTH = 32'd 1;
 parameter LOG_BUS_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 3;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter LOG_BUS_C_DATA_BITWIDTH = 32'd 32;
parameter LOG_BUS_mem_depth = 32'd 1;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_LOG_BUS_AWVALID;
output  TRAN_LOG_BUS_AWREADY;
input [LOG_BUS_ADDR_BITWIDTH - 1 : 0] TRAN_LOG_BUS_AWADDR;
input [LOG_BUS_ID_BITWIDTH - 1 : 0] TRAN_LOG_BUS_AWID;
input [8 - 1 : 0] TRAN_LOG_BUS_AWLEN;
input [3 - 1 : 0] TRAN_LOG_BUS_AWSIZE;
input [2 - 1 : 0] TRAN_LOG_BUS_AWBURST;
input [2 - 1 : 0] TRAN_LOG_BUS_AWLOCK;
input [4 - 1 : 0] TRAN_LOG_BUS_AWCACHE;
input [3 - 1 : 0] TRAN_LOG_BUS_AWPROT;
input [4 - 1 : 0] TRAN_LOG_BUS_AWQOS;
input [4 - 1 : 0] TRAN_LOG_BUS_AWREGION;
input [LOG_BUS_AWUSER_BITWIDTH - 1 : 0] TRAN_LOG_BUS_AWUSER;
input  TRAN_LOG_BUS_WVALID;
output  TRAN_LOG_BUS_WREADY;
input [LOG_BUS_DATA_BITWIDTH - 1 : 0] TRAN_LOG_BUS_WDATA;
input [LOG_BUS_DATA_BITWIDTH/8 - 1 : 0] TRAN_LOG_BUS_WSTRB;
input  TRAN_LOG_BUS_WLAST;
input  TRAN_LOG_BUS_WID;
input [LOG_BUS_WUSER_BITWIDTH - 1 : 0] TRAN_LOG_BUS_WUSER;
input  TRAN_LOG_BUS_ARVALID;
output  TRAN_LOG_BUS_ARREADY;
input [LOG_BUS_ADDR_BITWIDTH - 1 : 0] TRAN_LOG_BUS_ARADDR;
input [LOG_BUS_ID_BITWIDTH - 1 : 0] TRAN_LOG_BUS_ARID;
input [8 - 1 : 0] TRAN_LOG_BUS_ARLEN;
input [3 - 1 : 0] TRAN_LOG_BUS_ARSIZE;
input [2 - 1 : 0] TRAN_LOG_BUS_ARBURST;
input [2 - 1 : 0] TRAN_LOG_BUS_ARLOCK;
input [4 - 1 : 0] TRAN_LOG_BUS_ARCACHE;
input [3 - 1 : 0] TRAN_LOG_BUS_ARPROT;
input [4 - 1 : 0] TRAN_LOG_BUS_ARQOS;
input [4 - 1 : 0] TRAN_LOG_BUS_ARREGION;
input  TRAN_LOG_BUS_ARUSER;
output  TRAN_LOG_BUS_RVALID;
input  TRAN_LOG_BUS_RREADY;
output [LOG_BUS_DATA_BITWIDTH - 1 : 0] TRAN_LOG_BUS_RDATA;
output  TRAN_LOG_BUS_RLAST;
output [LOG_BUS_ID_BITWIDTH - 1 : 0] TRAN_LOG_BUS_RID;
output [LOG_BUS_RUSER_BITWIDTH - 1 : 0] TRAN_LOG_BUS_RUSER;
output [2 - 1 : 0] TRAN_LOG_BUS_RRESP;
output  TRAN_LOG_BUS_BVALID;
input  TRAN_LOG_BUS_BREADY;
output [2 - 1 : 0] TRAN_LOG_BUS_BRESP;
output [LOG_BUS_ID_BITWIDTH - 1 : 0] TRAN_LOG_BUS_BID;
output [LOG_BUS_BUSER_BITWIDTH - 1 : 0] TRAN_LOG_BUS_BUSER;
output [32 - 1 : 0] TRAN_LOG_BUS_log;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [LOG_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [LOG_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [LOG_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [LOG_BUS_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [LOG_BUS_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [LOG_BUS_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [LOG_BUS_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [32 - 1 : 0] log = 0;
reg [LOG_BUS_DATA_BITWIDTH - 1 : 0] LOG_BUS_mem_0 [0: LOG_BUS_mem_depth - 1]; 
reg [LOG_BUS_DATA_BITWIDTH - 1 : 0] LOG_BUS_mem_1 [0: LOG_BUS_mem_depth - 1]; 
reg [LOG_BUS_DATA_BITWIDTH - 1 : 0] LOG_BUS_mem_2 [0: LOG_BUS_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [LOG_BUS_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [LOG_BUS_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [LOG_BUS_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;

assign TRAN_LOG_BUS_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_LOG_BUS_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_LOG_BUS_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_LOG_BUS_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_LOG_BUS_BRESP = BRESP_tmp;
assign TRAN_LOG_BUS_RDATA = RDATA_tmp;
assign TRAN_LOG_BUS_RRESP = RRESP_tmp;
assign TRAN_LOG_BUS_RLAST = RLAST_tmp;
assign TRAN_LOG_BUS_RVALID = RVALID_tmp;
assign    TRAN_LOG_BUS_log = log;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = LOG_BUS_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
  log <= 0 * DATA_byte_num;
end

initial begin : initialize_LOG_BUS_mem
  integer i;
  for (i = 0; i < LOG_BUS_mem_depth; i = i + 1) begin
      LOG_BUS_mem_0[i] = 0;
      LOG_BUS_mem_1[i] = 0;
      LOG_BUS_mem_2[i] = 0;
  end
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_LOG_BUS_AWREADY & TRAN_LOG_BUS_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_LOG_BUS_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_LOG_BUS_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_LOG_BUS_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_LOG_BUS_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_LOG_BUS_ARREADY & TRAN_LOG_BUS_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_LOG_BUS_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_LOG_BUS_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_LOG_BUS_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_LOG_BUS_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_LOG_BUS_WREADY & TRAN_LOG_BUS_WVALID ) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_LOG_BUS_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_LOG_BUS_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_LOG_BUS_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_LOG_BUS_AWVALID && TRAN_LOG_BUS_AWREADY && (FIFO_AW_req_ptr_w == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_LOG_BUS_ARVALID && TRAN_LOG_BUS_ARREADY && (FIFO_AR_req_ptr_w == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_LOG_BUS_WVALID && TRAN_LOG_BUS_WREADY && (FIFO_WDATA_req_ptr_w == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_LOG_BUS_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_LOG_BUS_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [LOG_BUS_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [LOG_BUS_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [LOG_BUS_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > LOG_BUS_mem_depth) begin
                $display ("A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_9_fetchACP_withReadalloc/fetchACP_withReadalloc/solution1/sim/verilog/AESL_axi_master_LOG_BUS.v: Write request address %d exceed AXI master LOG_BUS array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, LOG_BUS_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = LOG_BUS_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = LOG_BUS_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = LOG_BUS_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : LOG_BUS_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : LOG_BUS_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : LOG_BUS_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = LOG_BUS_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = LOG_BUS_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = LOG_BUS_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : LOG_BUS_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : LOG_BUS_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : LOG_BUS_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > LOG_BUS_mem_depth) begin
                $display ("A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_9_fetchACP_withReadalloc/fetchACP_withReadalloc/solution1/sim/verilog/AESL_axi_master_LOG_BUS.v: Read request address %d exceed AXI master LOG_BUS array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, LOG_BUS_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= LOG_BUS_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= LOG_BUS_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= LOG_BUS_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_LOG_BUS_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= LOG_BUS_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= LOG_BUS_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= LOG_BUS_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer LOG_BUS_bitwidth; 
  reg [127 : 0] token; 
  reg [LOG_BUS_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [LOG_BUS_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  LOG_BUS_bitwidth = LOG_BUS_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (LOG_BUS_bitwidth , factor);
  fp = $fopen(`TV_IN_LOG_BUS,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_LOG_BUS); 
      $finish; 
  end 
  token = read_token(fp); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [LOG_BUS_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < 1 ; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : LOG_BUS_mem_0[i/factor] = mem_tmp;
                      1 : LOG_BUS_mem_1[i/factor] = mem_tmp;
                      2 : LOG_BUS_mem_2[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : LOG_BUS_mem_0[i] = mem_tmp;
                  1 : LOG_BUS_mem_1[i] = mem_tmp;
                  2 : LOG_BUS_mem_2[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [LOG_BUS_DATA_BITWIDTH - 1: 0] = 0;
          end
...
initial begin : write_file_proc 
  ...
  integer mem_page; 
  integer LOG_BUS_bitwidth; 
  reg [LOG_BUS_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  reg [LOG_BUS_DATA_BITWIDTH - 1 : 0] tmp_data;
  transaction_num = 0; 
  LOG_BUS_bitwidth = LOG_BUS_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (LOG_BUS_bitwidth , factor);
  while(1) begin 
      ...
      mem_page = transaction_num % mem_page_num ;
      # 0.1;
      fp = $fopen(`TV_OUT_LOG_BUS, "a"); 
      if(fp == 0) begin       // Failed to open file 
          $display("Failed to open file \"%s\"!", `TV_OUT_LOG_BUS); 
          $finish; 
      end 
      $fdisplay(fp, "[[transaction]] %d", transaction_num);
      for(i = 0; i < (LOG_BUS_mem_depth - LOG_BUS_mem_depth % factor); i = i + 1) begin 
          if (factor == 4) begin
              case(mem_page)
                  0 : tmp_data = LOG_BUS_mem_0[i/factor];
                  1 : tmp_data = LOG_BUS_mem_1[i/factor];
                  2 : tmp_data = LOG_BUS_mem_2[i/factor];
          ...
          if (factor == 1) begin
              case(mem_page)
                  0 : mem_tmp = LOG_BUS_mem_0[i];
                  1 : mem_tmp = LOG_BUS_mem_1[i];
                  2 : mem_tmp = LOG_BUS_mem_2[i];
                  default: $display("The page_num of write file is not valid!");
              endcase
              $fdisplay(fp,"0x%x",mem_tmp);
          end
      ...
      if (factor == 4) begin
          case(mem_page)
              0 : tmp_data = LOG_BUS_mem_0[LOG_BUS_mem_depth/factor];
              1 : tmp_data = LOG_BUS_mem_1[LOG_BUS_mem_depth/factor];
              2 : tmp_data = LOG_BUS_mem_2[LOG_BUS_mem_depth/factor];
              default: $display("The page_num of write file is not valid!");
          endcase
          if ((LOG_BUS_mem_depth - 1) % factor == 2) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
              $fdisplay(fp,"0x%x",tmp_data[23:16]);
          end
          if ((LOG_BUS_mem_depth - 1) % factor == 1) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
              $fdisplay(fp,"0x%x",tmp_data[15:8]);
          end
          if ((LOG_BUS_mem_depth - 1) % factor == 0) begin
              $fdisplay(fp,"0x%x",tmp_data[7:0]);
          end
      end
      if (factor == 2) begin
          if ((LOG_BUS_mem_depth - 1) % factor == 0) begin
              case(mem_page)
                  0 : $fdisplay(fp,"0x%x",LOG_BUS_mem_0[LOG_BUS_mem_depth/factor][15:0]);
                  1 : $fdisplay(fp,"0x%x",LOG_BUS_mem_1[LOG_BUS_mem_depth/factor][15:0]);
                  2 : $fdisplay(fp,"0x%x",LOG_BUS_mem_2[LOG_BUS_mem_depth/factor][15:0]);
                  default: $display("The page_num of write file is not valid!");
              endcase
          end
      end
