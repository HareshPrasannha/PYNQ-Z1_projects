...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fetch_readalloc.autotvin.dat"
	set constFileTvOut       "fetch_readalloc.autotvout.dat"
	set constFileHdlTvIn     "fetch_readalloc.autohdltvin.dat"
	set constFileHdlTvOut    "fetch_readalloc.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
