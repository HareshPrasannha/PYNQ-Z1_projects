...
@p_str6 = private unnamed_addr constant [4 x i8] c"CFG\00", align 1
...
define void @skipprefetch_Nelem(i64* %A_BUS, i32 %a) {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @p_str5, i32 0, i32 0, [1 x i8]* @p_str, i32 0, i32 0, [4 x i8]* @p_str6, [1 x i8]* @p_str, [1 x i8]* @p_str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str, [1 x i8]* @p_str) nounwind
  br label %1

; <label>:1                                       ; preds = %2, %0
  %i = phi i5 [ 0, %0 ], [ %i_1, %2 ]
  %cum_offs = phi i21 [ 0, %0 ], [ %cum_offs_1, %2 ]
  %i_cast2 = zext i5 %i to i32
  %exitcond2 = icmp eq i5 %i, -12
...
; <label>:2                                       ; preds = %1
  %cum_offs_cast4_cast = sext i21 %cum_offs to i31
  ...
  %tmp_cast = sext i16 %tmp_3 to i21
  %tmp_1 = add i21 %tmp_cast, %cum_offs
  %tmp_1_cast = sext i21 %tmp_1 to i32
  %buff_addr = getelementptr inbounds [20 x i32]* %buff, i32 0, i32 %i_cast2
  ...
  %tmp_2_cast = sext i16 %tmp_4 to i21
  %cum_offs_1 = add i21 %cum_offs, %tmp_2_cast
  br label %1

.preheader:                                       ; preds = %.preheader.preheader, %.preheader3
  %indvar_flatten = phi i10 [ %indvar_flatten_next, %.preheader3 ], [ 0, %.preheader.preheader ]
  %i1 = phi i5 [ %i_2, %.preheader3 ], [ 1, %.preheader.preheader ]
  %exitcond_flatten = icmp eq i10 %indvar_flatten, -93
  %indvar_flatten_next = add i10 %indvar_flatten, 1
  br i1 %exitcond_flatten, label %3, label %.preheader3

.preheader3:                                      ; preds = %.preheader
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 931, i64 931, i64 931)
  %exitcond5 = icmp eq i5 %i1, -12
  %i1_mid2 = select i1 %exitcond5, i5 1, i5 %i1
  %i1_cast1 = zext i5 %i1_mid2 to i32
  %tmp_5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str7)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str) nounwind
  %buff_addr_1 = getelementptr inbounds [20 x i32]* %buff, i32 0, i32 %i1_cast1
  ...
  %empty_8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str7, i32 %tmp_5)
  %i_2 = add i5 %i1_mid2, 1
  br label %.preheader
