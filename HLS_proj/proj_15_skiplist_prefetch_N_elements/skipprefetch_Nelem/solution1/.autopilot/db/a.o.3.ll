...
define void @skipprefetch_Nelem(i64* %A_BUS, i32 %a) {
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @p_str4, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [4 x i8]* @p_str5, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1) nounwind, !dbg !68 ; [debug line = 21:1]
  call void @llvm.dbg.declare(metadata !{[10 x i32]* %buff}, metadata !70), !dbg !74 ; [debug line = 26:7] [debug variable = buff]
  br label %1, !dbg !75                           ; [debug line = 48:14]

; <label>:1                                       ; preds = %2, %0
  %i = phi i4 [ 0, %0 ], [ %i_1, %2 ]             ; [#uses=3 type=i4]
  %cum_offs = phi i20 [ 0, %0 ], [ %cum_offs_1, %2 ] ; [#uses=3 type=i20]
  %i_cast2 = zext i4 %i to i32, !dbg !75          ; [#uses=1 type=i32] [debug line = 48:14]
  %exitcond2 = icmp eq i4 %i, -6, !dbg !75        ; [#uses=1 type=i1] [debug line = 48:14]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 10, i64 10, i64 10) ; [#uses=0 type=i32]
  %i_1 = add i4 %i, 1, !dbg !77                   ; [#uses=1 type=i4] [debug line = 48:26]
  br i1 %exitcond2, label %.preheader.preheader, label %2, !dbg !75 ; [debug line = 48:14]

.preheader.preheader:                             ; preds = %1
  br label %.preheader

; <label>:2                                       ; preds = %1
  %cum_offs_cast4_cast = sext i20 %cum_offs to i31, !dbg !78 ; [#uses=1 type=i31] [debug line = 56:5]
  %a2_sum = add i31 %cum_offs_cast4_cast, %tmp_cast6, !dbg !78 ; [#uses=1 type=i31] [debug line = 56:5]
  %a2_sum_cast = sext i31 %a2_sum to i32, !dbg !78 ; [#uses=1 type=i32] [debug line = 56:5]
  %A_BUS_addr = getelementptr i64* %A_BUS, i32 %a2_sum_cast, !dbg !78 ; [#uses=4 type=i64*] [debug line = 56:5]
  %A_BUS_load_req = call i1 @_ssdm_op_ReadReq.m_axi.i64P(i64* %A_BUS_addr, i32 1), !dbg !78 ; [#uses=0 type=i1] [debug line = 56:5]
  %A_BUS_addr_read = call i64 @_ssdm_op_Read.m_axi.volatile.i64P(i64* %A_BUS_addr), !dbg !78 ; [#uses=1 type=i64] [debug line = 56:5]
  %tmp_3 = call i16 @_ssdm_op_PartSelect.i16.i64.i32.i32(i64 %A_BUS_addr_read, i32 32, i32 47), !dbg !78 ; [#uses=1 type=i16] [debug line = 56:5]
  %tmp_cast = sext i16 %tmp_3 to i20, !dbg !78    ; [#uses=1 type=i20] [debug line = 56:5]
  %tmp_1 = add i20 %tmp_cast, %cum_offs, !dbg !78 ; [#uses=1 type=i20] [debug line = 56:5]
  %tmp_1_cast = sext i20 %tmp_1 to i32, !dbg !78  ; [#uses=1 type=i32] [debug line = 56:5]
  %buff_addr = getelementptr inbounds [10 x i32]* %buff, i32 0, i32 %i_cast2, !dbg !78 ; [#uses=1 type=i32*] [debug line = 56:5]
  store i32 %tmp_1_cast, i32* %buff_addr, align 4, !dbg !78 ; [debug line = 56:5]
  %A_BUS_load_1_req = call i1 @_ssdm_op_ReadReq.m_axi.i64P(i64* %A_BUS_addr, i32 1), !dbg !80 ; [#uses=0 type=i1] [debug line = 57:5]
  %A_BUS_addr_read_1 = call i64 @_ssdm_op_Read.m_axi.volatile.i64P(i64* %A_BUS_addr), !dbg !80 ; [#uses=1 type=i64] [debug line = 57:5]
  %tmp_4 = call i16 @_ssdm_op_PartSelect.i16.i64.i32.i32(i64 %A_BUS_addr_read_1, i32 48, i32 63), !dbg !80 ; [#uses=1 type=i16] [debug line = 57:5]
  %tmp_2_cast = sext i16 %tmp_4 to i20, !dbg !80  ; [#uses=1 type=i20] [debug line = 57:5]
  %cum_offs_1 = add i20 %cum_offs, %tmp_2_cast, !dbg !80 ; [#uses=1 type=i20] [debug line = 57:5]
  call void @llvm.dbg.value(metadata !{i20 %cum_offs_1}, i64 0, metadata !81), !dbg !80 ; [debug line = 57:5] [debug variable = cum_offs]
  call void @llvm.dbg.value(metadata !{i4 %i_1}, i64 0, metadata !82), !dbg !77 ; [debug line = 48:26] [debug variable = i]
...
.preheader3:                                      ; preds = %.preheader
  ...
  br label %.preheader, !dbg !92                  ; [debug line = 64:27]

; <label>:3                                       ; preds = %.preheader
  ret void, !dbg !94                              ; [debug line = 72:1]
}
...
!68 = metadata !{i32 21, i32 1, metadata !69, null}
!69 = metadata !{i32 786443, metadata !24, i32 19, i32 1, metadata !25, i32 0} ; [ DW_TAG_lexical_block ]
!70 = metadata !{i32 786688, metadata !69, metadata !"buff", metadata !25, i32 26, metadata !71, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!71 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 320, i64 32, i32 0, i32 0, metadata !34, metadata !72, i32 0, i32 0} ; [ DW_TAG_array_type ]
!72 = metadata !{metadata !73}
!73 = metadata !{i32 786465, i64 0, i64 9}        ; [ DW_TAG_subrange_type ]
!74 = metadata !{i32 26, i32 7, metadata !69, null}
!75 = metadata !{i32 48, i32 14, metadata !76, null}
!76 = metadata !{i32 786443, metadata !69, i32 48, i32 3, metadata !25, i32 1} ; [ DW_TAG_lexical_block ]
!77 = metadata !{i32 48, i32 26, metadata !76, null}
!78 = metadata !{i32 56, i32 5, metadata !79, null}
!79 = metadata !{i32 786443, metadata !76, i32 48, i32 30, metadata !25, i32 2} ; [ DW_TAG_lexical_block ]
!80 = metadata !{i32 57, i32 5, metadata !79, null}
!81 = metadata !{i32 786688, metadata !69, metadata !"cum_offs", metadata !25, i32 27, metadata !34, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!82 = metadata !{i32 786688, metadata !76, metadata !"i", metadata !25, i32 48, metadata !34, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!83 = metadata !{i32 64, i32 15, metadata !84, null}
!84 = metadata !{i32 786443, metadata !85, i32 64, i32 4, metadata !25, i32 5} ; [ DW_TAG_lexical_block ]
!85 = metadata !{i32 786443, metadata !86, i32 63, i32 34, metadata !25, i32 4} ; [ DW_TAG_lexical_block ]
!86 = metadata !{i32 786443, metadata !69, i32 63, i32 3, metadata !25, i32 3} ; [ DW_TAG_lexical_block ]
...
!94 = metadata !{i32 72, i32 1, metadata !69, null}
