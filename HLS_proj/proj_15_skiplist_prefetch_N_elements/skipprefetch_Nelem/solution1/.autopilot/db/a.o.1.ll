...
define void @skipprefetch_Nelem(%struct.node.1* %a) nounwind {
  ...
  call void (...)* @_ssdm_DataPack(%struct.node.1* %a, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !58 ; [debug line = 20:1]
  ...
  call void @llvm.dbg.declare(metadata !{[20 x i32]* %buff}, metadata !62), !dbg !66 ; [debug line = 27:7] [debug variable = buff]
  br label %1, !dbg !67                           ; [debug line = 50:14]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=3 type=i32]
  %cum_offs = phi i32 [ 0, %0 ], [ %cum_offs.1, %2 ] ; [#uses=4 type=i32]
  %exitcond2 = icmp eq i32 %i, 20, !dbg !67       ; [#uses=1 type=i1] [debug line = 50:14]
  br i1 %exitcond2, label %.preheader3.preheader, label %2, !dbg !67 ; [debug line = 50:14]

.preheader3.preheader:                            ; preds = %1
  br label %.preheader3, !dbg !69                 ; [debug line = 65:15]

; <label>:2                                       ; preds = %1
  %a.addr = getelementptr inbounds %struct.node.1* %a, i32 %cum_offs, i32 1, i32 0, !dbg !71 ; [#uses=1 type=i16*] [debug line = 58:5]
  %a.load = load volatile i16* %a.addr, align 2, !dbg !71 ; [#uses=1 type=i16] [debug line = 58:5]
  %tmp = sext i16 %a.load to i32, !dbg !71        ; [#uses=1 type=i32] [debug line = 58:5]
  %tmp.1 = add nsw i32 %tmp, %cum_offs, !dbg !71  ; [#uses=1 type=i32] [debug line = 58:5]
  %buff.addr = getelementptr inbounds [20 x i32]* %buff, i32 0, i32 %i, !dbg !71 ; [#uses=1 type=i32*] [debug line = 58:5]
  store i32 %tmp.1, i32* %buff.addr, align 4, !dbg !71 ; [debug line = 58:5]
  %a.addr.1 = getelementptr inbounds %struct.node.1* %a, i32 %cum_offs, i32 1, i32 1, !dbg !73 ; [#uses=1 type=i16*] [debug line = 59:5]
  %a.load.1 = load volatile i16* %a.addr.1, align 2, !dbg !73 ; [#uses=1 type=i16] [debug line = 59:5]
  %tmp.2 = sext i16 %a.load.1 to i32, !dbg !73    ; [#uses=1 type=i32] [debug line = 59:5]
  %cum_offs.1 = add nsw i32 %tmp.2, %cum_offs, !dbg !73 ; [#uses=1 type=i32] [debug line = 59:5]
  call void @llvm.dbg.value(metadata !{i32 %cum_offs.1}, i64 0, metadata !74), !dbg !73 ; [debug line = 59:5] [debug variable = cum_offs]
  %i.1 = add nsw i32 %i, 1, !dbg !75              ; [#uses=1 type=i32] [debug line = 50:26]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !76), !dbg !75 ; [debug line = 50:26] [debug variable = i]
  br label %1, !dbg !75                           ; [debug line = 50:26]

.preheader3:                                      ; preds = %4, %.preheader3.preheader
  %j = phi i32 [ %j.1, %4 ], [ 0, %.preheader3.preheader ] ; [#uses=2 type=i32]
  %exitcond1 = icmp eq i32 %j, 49, !dbg !69       ; [#uses=1 type=i1] [debug line = 65:15]
  br i1 %exitcond1, label %5, label %.preheader.preheader, !dbg !69 ; [debug line = 65:15]

.preheader.preheader:                             ; preds = %.preheader3
  br label %.preheader, !dbg !77                  ; [debug line = 66:15]

.preheader:                                       ; preds = %3, %.preheader.preheader
  %i1 = phi i32 [ %i.2, %3 ], [ 1, %.preheader.preheader ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i1, 20, !dbg !77       ; [#uses=1 type=i1] [debug line = 66:15]
  br i1 %exitcond, label %4, label %3, !dbg !77   ; [debug line = 66:15]

; <label>:3                                       ; preds = %.preheader
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !80 ; [#uses=1 type=i32] [debug line = 66:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !82 ; [debug line = 67:1]
  %buff.addr.1 = getelementptr inbounds [20 x i32]* %buff, i32 0, i32 %i1, !dbg !83 ; [#uses=2 type=i32*] [debug line = 71:5]
  %buff.load = load i32* %buff.addr.1, align 4, !dbg !83 ; [#uses=4 type=i32] [debug line = 71:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %buff.load) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %buff.load) nounwind
  %a.addr.2 = getelementptr inbounds %struct.node.1* %a, i32 %buff.load, i32 1, i32 0, !dbg !83 ; [#uses=1 type=i16*] [debug line = 71:5]
  %a.load.2 = load volatile i16* %a.addr.2, align 2, !dbg !83 ; [#uses=1 type=i16] [debug line = 71:5]
  %tmp.6 = sext i16 %a.load.2 to i32, !dbg !83    ; [#uses=1 type=i32] [debug line = 71:5]
  %tmp.7 = add nsw i32 %tmp.6, %buff.load, !dbg !83 ; [#uses=1 type=i32] [debug line = 71:5]
  store i32 %tmp.7, i32* %buff.addr.1, align 4, !dbg !83 ; [debug line = 71:5]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !84 ; [#uses=0 type=i32] [debug line = 72:4]
  %i.2 = add nsw i32 %i1, 1, !dbg !85             ; [#uses=1 type=i32] [debug line = 66:27]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !86), !dbg !85 ; [debug line = 66:27] [debug variable = i]
  br label %.preheader, !dbg !85                  ; [debug line = 66:27]

; <label>:4                                       ; preds = %.preheader
  %j.1 = add nsw i32 %j, 1, !dbg !87              ; [#uses=1 type=i32] [debug line = 65:30]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !88), !dbg !87 ; [debug line = 65:30] [debug variable = j]
  br label %.preheader3, !dbg !87                 ; [debug line = 65:30]

; <label>:5                                       ; preds = %.preheader3
  ret void, !dbg !89                              ; [debug line = 82:1]
}
...
!63 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 640, i64 32, i32 0, i32 0, metadata !15, metadata !64, i32 0, i32 0} ; [ DW_TAG_array_type ]
!64 = metadata !{metadata !65}
!65 = metadata !{i32 786465, i64 0, i64 19}       ; [ DW_TAG_subrange_type ]
!66 = metadata !{i32 27, i32 7, metadata !59, null}
!67 = metadata !{i32 50, i32 14, metadata !68, null}
!68 = metadata !{i32 786443, metadata !59, i32 50, i32 3, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!69 = metadata !{i32 65, i32 15, metadata !70, null}
!70 = metadata !{i32 786443, metadata !59, i32 65, i32 3, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!71 = metadata !{i32 58, i32 5, metadata !72, null}
!72 = metadata !{i32 786443, metadata !68, i32 50, i32 30, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!73 = metadata !{i32 59, i32 5, metadata !72, null}
!74 = metadata !{i32 786688, metadata !59, metadata !"cum_offs", metadata !6, i32 28, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!75 = metadata !{i32 50, i32 26, metadata !68, null}
!76 = metadata !{i32 786688, metadata !68, metadata !"i", metadata !6, i32 50, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!77 = metadata !{i32 66, i32 15, metadata !78, null}
!78 = metadata !{i32 786443, metadata !79, i32 66, i32 4, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!79 = metadata !{i32 786443, metadata !70, i32 65, i32 34, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!80 = metadata !{i32 66, i32 32, metadata !81, null}
!81 = metadata !{i32 786443, metadata !78, i32 66, i32 31, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!82 = metadata !{i32 67, i32 1, metadata !81, null}
!83 = metadata !{i32 71, i32 5, metadata !81, null}
!84 = metadata !{i32 72, i32 4, metadata !81, null}
!85 = metadata !{i32 66, i32 27, metadata !78, null}
!86 = metadata !{i32 786688, metadata !78, metadata !"i", metadata !6, i32 66, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!87 = metadata !{i32 65, i32 30, metadata !70, null}
!88 = metadata !{i32 786688, metadata !70, metadata !"j", metadata !6, i32 65, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!89 = metadata !{i32 82, i32 1, metadata !59, null}
