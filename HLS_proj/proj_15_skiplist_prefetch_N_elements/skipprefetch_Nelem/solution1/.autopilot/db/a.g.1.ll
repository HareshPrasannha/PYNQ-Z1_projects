...
define void @skipprefetch_Nelem(%struct.node.1* %a) nounwind {
  ...
  call void @llvm.dbg.declare(metadata !{[50 x i32]* %buff}, metadata !62), !dbg !66 ; [debug line = 27:7] [debug variable = buff]
  br label %1, !dbg !67                           ; [debug line = 46:14]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=3 type=i32]
  %cum_offs = phi i32 [ 0, %0 ], [ %cum_offs.1, %2 ] ; [#uses=4 type=i32]
  %exitcond2 = icmp eq i32 %i, 50, !dbg !67       ; [#uses=1 type=i1] [debug line = 46:14]
  br i1 %exitcond2, label %.preheader3.preheader, label %2, !dbg !67 ; [debug line = 46:14]

.preheader3.preheader:                            ; preds = %1
  br label %.preheader3, !dbg !69                 ; [debug line = 61:15]

; <label>:2                                       ; preds = %1
  %a.addr = getelementptr inbounds %struct.node.1* %a, i32 %cum_offs, i32 1, i32 0, !dbg !71 ; [#uses=1 type=i16*] [debug line = 54:5]
  %a.load = load volatile i16* %a.addr, align 2, !dbg !71 ; [#uses=1 type=i16] [debug line = 54:5]
  %tmp = sext i16 %a.load to i32, !dbg !71        ; [#uses=1 type=i32] [debug line = 54:5]
  %tmp.1 = add nsw i32 %tmp, %cum_offs, !dbg !71  ; [#uses=1 type=i32] [debug line = 54:5]
  %buff.addr = getelementptr inbounds [50 x i32]* %buff, i32 0, i32 %i, !dbg !71 ; [#uses=1 type=i32*] [debug line = 54:5]
  store i32 %tmp.1, i32* %buff.addr, align 4, !dbg !71 ; [debug line = 54:5]
  %a.addr.1 = getelementptr inbounds %struct.node.1* %a, i32 %cum_offs, i32 1, i32 1, !dbg !73 ; [#uses=1 type=i16*] [debug line = 55:5]
  %a.load.1 = load volatile i16* %a.addr.1, align 2, !dbg !73 ; [#uses=1 type=i16] [debug line = 55:5]
  ...
  %i.1 = add nsw i32 %i, 1, !dbg !75              ; [#uses=1 type=i32] [debug line = 46:26]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !76), !dbg !75 ; [debug line = 46:26] [debug variable = i]
  br label %1, !dbg !75                           ; [debug line = 46:26]

.preheader3:                                      ; preds = %4, %.preheader3.preheader
  %j = phi i32 [ %j.1, %4 ], [ 0, %.preheader3.preheader ] ; [#uses=2 type=i32]
  %exitcond1 = icmp eq i32 %j, 19, !dbg !69       ; [#uses=1 type=i1] [debug line = 61:15]
  br i1 %exitcond1, label %5, label %.preheader.preheader, !dbg !69 ; [debug line = 61:15]

.preheader.preheader:                             ; preds = %.preheader3
  br label %.preheader, !dbg !77                  ; [debug line = 62:15]

.preheader:                                       ; preds = %3, %.preheader.preheader
  %i1 = phi i32 [ %i.2, %3 ], [ 1, %.preheader.preheader ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i1, 50, !dbg !77       ; [#uses=1 type=i1] [debug line = 62:15]
  br i1 %exitcond, label %4, label %3, !dbg !77   ; [debug line = 62:15]

; <label>:3                                       ; preds = %.preheader
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !80 ; [#uses=1 type=i32] [debug line = 62:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !82 ; [debug line = 63:1]
  %buff.addr.1 = getelementptr inbounds [50 x i32]* %buff, i32 0, i32 %i1, !dbg !83 ; [#uses=2 type=i32*] [debug line = 67:6]
  %buff.load = load i32* %buff.addr.1, align 4, !dbg !83 ; [#uses=4 type=i32] [debug line = 67:6]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %buff.load) nounwind
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %buff.load) nounwind
  %a.addr.2 = getelementptr inbounds %struct.node.1* %a, i32 %buff.load, i32 1, i32 0, !dbg !83 ; [#uses=1 type=i16*] [debug line = 67:6]
  %a.load.2 = load volatile i16* %a.addr.2, align 2, !dbg !83 ; [#uses=1 type=i16] [debug line = 67:6]
  %tmp.6 = sext i16 %a.load.2 to i32, !dbg !83    ; [#uses=1 type=i32] [debug line = 67:6]
  %tmp.7 = add nsw i32 %tmp.6, %buff.load, !dbg !83 ; [#uses=1 type=i32] [debug line = 67:6]
  store i32 %tmp.7, i32* %buff.addr.1, align 4, !dbg !83 ; [debug line = 67:6]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !84 ; [#uses=0 type=i32] [debug line = 68:4]
  %i.2 = add nsw i32 %i1, 1, !dbg !85             ; [#uses=1 type=i32] [debug line = 62:27]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !86), !dbg !85 ; [debug line = 62:27] [debug variable = i]
  br label %.preheader, !dbg !85                  ; [debug line = 62:27]

; <label>:4                                       ; preds = %.preheader
  %j.1 = add nsw i32 %j, 1, !dbg !87              ; [#uses=1 type=i32] [debug line = 61:30]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !88), !dbg !87 ; [debug line = 61:30] [debug variable = j]
  br label %.preheader3, !dbg !87                 ; [debug line = 61:30]

; <label>:5                                       ; preds = %.preheader3
  ret void, !dbg !89                              ; [debug line = 70:1]
}
...
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"skipprefetch_Nelem", metadata !"skipprefetch_Nelem", metadata !"_Z18skipprefetch_NelemPV4node", metadata !6, i32 19, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.node.1*)* @skipprefetch_Nelem, null, null, metadata !22, i32 20} ; [ DW_TAG_subprogram ]
...
!63 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1600, i64 32, i32 0, i32 0, metadata !15, metadata !64, i32 0, i32 0} ; [ DW_TAG_array_type ]
!64 = metadata !{metadata !65}
!65 = metadata !{i32 786465, i64 0, i64 49}       ; [ DW_TAG_subrange_type ]
...
!69 = metadata !{i32 61, i32 15, metadata !70, null}
!70 = metadata !{i32 786443, metadata !59, i32 61, i32 3, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!71 = metadata !{i32 54, i32 5, metadata !72, null}
!72 = metadata !{i32 786443, metadata !68, i32 46, i32 30, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!73 = metadata !{i32 55, i32 5, metadata !72, null}
!74 = metadata !{i32 786688, metadata !59, metadata !"cum_offs", metadata !6, i32 28, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!75 = metadata !{i32 46, i32 26, metadata !68, null}
!76 = metadata !{i32 786688, metadata !68, metadata !"i", metadata !6, i32 46, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!77 = metadata !{i32 62, i32 15, metadata !78, null}
!78 = metadata !{i32 786443, metadata !79, i32 62, i32 4, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!79 = metadata !{i32 786443, metadata !70, i32 61, i32 34, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!80 = metadata !{i32 62, i32 32, metadata !81, null}
!81 = metadata !{i32 786443, metadata !78, i32 62, i32 31, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!82 = metadata !{i32 63, i32 1, metadata !81, null}
!83 = metadata !{i32 67, i32 6, metadata !81, null}
!84 = metadata !{i32 68, i32 4, metadata !81, null}
!85 = metadata !{i32 62, i32 27, metadata !78, null}
!86 = metadata !{i32 786688, metadata !78, metadata !"i", metadata !6, i32 62, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!87 = metadata !{i32 61, i32 30, metadata !70, null}
!88 = metadata !{i32 786688, metadata !70, metadata !"j", metadata !6, i32 61, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!89 = metadata !{i32 70, i32 1, metadata !59, null}
