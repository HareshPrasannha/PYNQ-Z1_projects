...
define void @skipprefetch_Nelem(i64* %a) {
  ...
  call void @llvm.dbg.declare(metadata !{[50 x i32]* %buff}, metadata !92), !dbg !96 ; [debug line = 27:7] [debug variable = buff]
  br label %1, !dbg !97                           ; [debug line = 46:14]

; <label>:1                                       ; preds = %3, %0
  %i = phi i6 [ 0, %0 ], [ %i.1, %3 ]             ; [#uses=3 type=i6]
  %cum_offs = phi i22 [ 0, %0 ], [ %cum_offs.1, %3 ] ; [#uses=3 type=i22]
  %i.cast2 = zext i6 %i to i32, !dbg !97          ; [#uses=1 type=i32] [debug line = 46:14]
  %cum_offs.cast = sext i22 %cum_offs to i32, !dbg !97 ; [#uses=1 type=i32] [debug line = 46:14]
  %exitcond2 = icmp eq i6 %i, -14, !dbg !97       ; [#uses=1 type=i1] [debug line = 46:14]
  %2 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 50, i64 50, i64 50) ; [#uses=0 type=i32]
  br i1 %exitcond2, label %.preheader3.preheader, label %3, !dbg !97 ; [debug line = 46:14]

.preheader3.preheader:                            ; preds = %1
  br label %.preheader3, !dbg !99                 ; [debug line = 61:15]

; <label>:3                                       ; preds = %1
  %a.addr = getelementptr i64* %a, i32 %cum_offs.cast, !dbg !101 ; [#uses=2 type=i64*] [debug line = 54:5]
  %a.load = load volatile i64* %a.addr, align 8, !dbg !101 ; [#uses=1 type=i64] [debug line = 54:5]
  %tmp.3 = call i16 @_ssdm_op_PartSelect.i16.i64.i32.i32(i64 %a.load, i32 32, i32 47), !dbg !101 ; [#uses=1 type=i16] [debug line = 54:5]
  %tmp.cast = sext i16 %tmp.3 to i22, !dbg !101   ; [#uses=1 type=i22] [debug line = 54:5]
  %tmp.1 = add i22 %tmp.cast, %cum_offs, !dbg !101 ; [#uses=1 type=i22] [debug line = 54:5]
  %tmp.1.cast = sext i22 %tmp.1 to i32, !dbg !101 ; [#uses=1 type=i32] [debug line = 54:5]
  %buff.addr = getelementptr inbounds [50 x i32]* %buff, i32 0, i32 %i.cast2, !dbg !101 ; [#uses=1 type=i32*] [debug line = 54:5]
  store i32 %tmp.1.cast, i32* %buff.addr, align 4, !dbg !101 ; [debug line = 54:5]
  %a.load.1 = load volatile i64* %a.addr, align 8, !dbg !103 ; [#uses=1 type=i64] [debug line = 55:5]
  %tmp.4 = call i16 @_ssdm_op_PartSelect.i16.i64.i32.i32(i64 %a.load.1, i32 48, i32 63), !dbg !103 ; [#uses=1 type=i16] [debug line = 55:5]
  %tmp.2.cast = sext i16 %tmp.4 to i22, !dbg !103 ; [#uses=1 type=i22] [debug line = 55:5]
  %cum_offs.1 = add i22 %cum_offs, %tmp.2.cast, !dbg !103 ; [#uses=1 type=i22] [debug line = 55:5]
  call void @llvm.dbg.value(metadata !{i22 %cum_offs.1}, i64 0, metadata !104), !dbg !103 ; [debug line = 55:5] [debug variable = cum_offs]
  %i.1 = add i6 %i, 1, !dbg !105                  ; [#uses=1 type=i6] [debug line = 46:26]
  call void @llvm.dbg.value(metadata !{i6 %i.1}, i64 0, metadata !106), !dbg !105 ; [debug line = 46:26] [debug variable = i]
  br label %1, !dbg !105                          ; [debug line = 46:26]

.preheader3:                                      ; preds = %8, %.preheader3.preheader
  %j = phi i5 [ %j.1, %8 ], [ 0, %.preheader3.preheader ] ; [#uses=2 type=i5]
  %exitcond1 = icmp eq i5 %j, -13, !dbg !99       ; [#uses=1 type=i1] [debug line = 61:15]
  %4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 19, i64 19, i64 19) ; [#uses=0 type=i32]
  br i1 %exitcond1, label %9, label %.preheader.preheader, !dbg !99 ; [debug line = 61:15]

.preheader.preheader:                             ; preds = %.preheader3
  br label %.preheader, !dbg !107                 ; [debug line = 62:15]

.preheader:                                       ; preds = %6, %.preheader.preheader
  %i1 = phi i6 [ %i.2, %6 ], [ 1, %.preheader.preheader ] ; [#uses=3 type=i6]
  %i1.cast1 = zext i6 %i1 to i32, !dbg !107       ; [#uses=1 type=i32] [debug line = 62:15]
  %exitcond = icmp eq i6 %i1, -14, !dbg !107      ; [#uses=1 type=i1] [debug line = 62:15]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 49, i64 49, i64 49) ; [#uses=0 type=i32]
  br i1 %exitcond, label %8, label %6, !dbg !107  ; [debug line = 62:15]

; <label>:6                                       ; preds = %.preheader
  %tmp.5 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @.str6), !dbg !110 ; [#uses=1 type=i32] [debug line = 62:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @.str1) nounwind, !dbg !112 ; [debug line = 63:1]
  %buff.addr.1 = getelementptr inbounds [50 x i32]* %buff, i32 0, i32 %i1.cast1, !dbg !113 ; [#uses=2 type=i32*] [debug line = 67:6]
  %buff.load = load i32* %buff.addr.1, align 4, !dbg !113 ; [#uses=2 type=i32] [debug line = 67:6]
  %a.addr.1 = getelementptr i64* %a, i32 %buff.load, !dbg !113 ; [#uses=1 type=i64*] [debug line = 67:6]
  %a.load.2 = load volatile i64* %a.addr.1, align 8, !dbg !113 ; [#uses=1 type=i64] [debug line = 67:6]
  %tmp.8 = call i16 @_ssdm_op_PartSelect.i16.i64.i32.i32(i64 %a.load.2, i32 32, i32 47), !dbg !113 ; [#uses=1 type=i16] [debug line = 67:6]
  %tmp.6 = sext i16 %tmp.8 to i32, !dbg !113      ; [#uses=1 type=i32] [debug line = 67:6]
  %tmp.7 = add nsw i32 %tmp.6, %buff.load, !dbg !113 ; [#uses=1 type=i32] [debug line = 67:6]
  store i32 %tmp.7, i32* %buff.addr.1, align 4, !dbg !113 ; [debug line = 67:6]
  %7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str6, i32 %tmp.5), !dbg !114 ; [#uses=0 type=i32] [debug line = 68:4]
  %i.2 = add i6 %i1, 1, !dbg !115                 ; [#uses=1 type=i6] [debug line = 62:27]
  call void @llvm.dbg.value(metadata !{i6 %i.2}, i64 0, metadata !116), !dbg !115 ; [debug line = 62:27] [debug variable = i]
  br label %.preheader, !dbg !115                 ; [debug line = 62:27]

; <label>:8                                       ; preds = %.preheader
  %j.1 = add i5 %j, 1, !dbg !117                  ; [#uses=1 type=i5] [debug line = 61:30]
  call void @llvm.dbg.value(metadata !{i5 %j.1}, i64 0, metadata !118), !dbg !117 ; [debug line = 61:30] [debug variable = j]
  br label %.preheader3, !dbg !117                ; [debug line = 61:30]

; <label>:9                                       ; preds = %.preheader3
  ret void, !dbg !119                             ; [debug line = 70:1]
}
...
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"skipprefetch_Nelem", metadata !"skipprefetch_Nelem", metadata !"_Z18skipprefetch_NelemPV4node", metadata !6, i32 19, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !22, i32 20} ; [ DW_TAG_subprogram ]
...
!93 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1600, i64 32, i32 0, i32 0, metadata !15, metadata !94, i32 0, i32 0} ; [ DW_TAG_array_type ]
!94 = metadata !{metadata !95}
!95 = metadata !{i32 786465, i64 0, i64 49}       ; [ DW_TAG_subrange_type ]
...
!99 = metadata !{i32 61, i32 15, metadata !100, null}
!100 = metadata !{i32 786443, metadata !91, i32 61, i32 3, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!101 = metadata !{i32 54, i32 5, metadata !102, null}
!102 = metadata !{i32 786443, metadata !98, i32 46, i32 30, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
...
!105 = metadata !{i32 46, i32 26, metadata !98, null}
!106 = metadata !{i32 786688, metadata !98, metadata !"i", metadata !6, i32 46, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!107 = metadata !{i32 62, i32 15, metadata !108, null}
!108 = metadata !{i32 786443, metadata !109, i32 62, i32 4, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!109 = metadata !{i32 786443, metadata !100, i32 61, i32 34, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!110 = metadata !{i32 62, i32 32, metadata !111, null}
!111 = metadata !{i32 786443, metadata !108, i32 62, i32 31, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!112 = metadata !{i32 63, i32 1, metadata !111, null}
!113 = metadata !{i32 67, i32 6, metadata !111, null}
!114 = metadata !{i32 68, i32 4, metadata !111, null}
!115 = metadata !{i32 62, i32 27, metadata !108, null}
!116 = metadata !{i32 786688, metadata !108, metadata !"i", metadata !6, i32 62, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!117 = metadata !{i32 61, i32 30, metadata !100, null}
!118 = metadata !{i32 786688, metadata !100, metadata !"j", metadata !6, i32 61, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!119 = metadata !{i32 70, i32 1, metadata !91, null}
