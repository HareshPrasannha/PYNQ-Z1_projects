...
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2016.3/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2016.3/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2016.3/win64/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2016.3/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2016.3/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "skipprefetch_Nelem.autotvin.dat"
	set constFileTvOut       "skipprefetch_Nelem.autotvout.dat"
	set constFileHdlTvIn     "skipprefetch_Nelem.autohdltvin.dat"
	set constFileHdlTvOut    "skipprefetch_Nelem.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
