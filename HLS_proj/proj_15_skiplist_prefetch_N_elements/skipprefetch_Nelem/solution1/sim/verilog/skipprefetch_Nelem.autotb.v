...
`define AUTOTB_DUT      skipprefetch_Nelem
`define AUTOTB_DUT_INST AESL_inst_skipprefetch_Nelem
`define AUTOTB_TOP      apatb_skipprefetch_Nelem_top
`define AUTOTB_LAT_RESULT_FILE "skipprefetch_Nelem.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "skipprefetch_Nelem.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_skipprefetch_Nelem_top
...
`define AUTOTB_TVIN_A_BUS_out_wrapc  "../tv/rtldatafile/rtl.skipprefetch_Nelem.autotvin_A_BUS.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.skipprefetch_Nelem.autotvin_a.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1673;
parameter LENGTH_A_BUS = 1;
