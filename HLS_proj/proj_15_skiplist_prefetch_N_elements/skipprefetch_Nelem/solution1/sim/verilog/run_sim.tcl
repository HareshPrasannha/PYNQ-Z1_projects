...
if {[file isfile skipprefetch_Nelem.autotvin.dat]} {
	file delete -force skipprefetch_Nelem.autotvin.dat
}

if {[file isfile skipprefetch_Nelem.autotvout.dat]} {
	file delete -force skipprefetch_Nelem.autotvout.dat
}
