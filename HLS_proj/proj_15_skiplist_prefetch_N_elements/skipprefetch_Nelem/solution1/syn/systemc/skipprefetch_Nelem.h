...
struct skipprefetch_Nelem : public sc_module {
    ...
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp0_iter1_exitcond_flatten_reg_378;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter9;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp0_iter8_exitcond_flatten_reg_378;
    ...
    sc_signal< sc_lv<10> > indvar_flatten_reg_152;
    sc_signal< sc_lv<6> > i1_reg_163;
    sc_signal< sc_lv<16> > reg_184;
    sc_signal< sc_logic > ap_sig_ioackin_A_BUS_ARREADY;
    sc_signal< sc_lv<32> > tmp_fu_198_p1;
    sc_signal< sc_lv<32> > tmp_reg_333;
    sc_signal< sc_lv<31> > tmp_cast6_fu_202_p1;
    sc_signal< sc_lv<31> > tmp_cast6_reg_338;
    sc_signal< sc_lv<32> > i_cast2_fu_206_p1;
    sc_signal< sc_lv<32> > i_cast2_reg_343;
    sc_signal< sc_lv<1> > ap_CS_fsm_state2;
    sc_signal< sc_lv<1> > exitcond2_fu_210_p2;
    sc_signal< sc_lv<6> > i_1_fu_216_p2;
    sc_signal< sc_lv<6> > i_1_reg_352;
    sc_signal< sc_lv<31> > a2_sum_fu_226_p2;
    sc_signal< sc_lv<31> > a2_sum_reg_357;
    sc_signal< sc_lv<32> > A_BUS_addr_reg_362;
    sc_signal< sc_lv<16> > tmp_4_reg_368;
    sc_signal< sc_lv<22> > cum_offs_1_fu_269_p2;
    sc_signal< sc_lv<1> > ap_CS_fsm_state12;
    sc_signal< sc_lv<1> > exitcond_flatten_fu_275_p2;
    sc_signal< sc_lv<1> > ap_CS_fsm_pp0_stage0;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp0_iter2_exitcond_flatten_reg_378;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp0_iter3_exitcond_flatten_reg_378;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp0_iter4_exitcond_flatten_reg_378;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp0_iter5_exitcond_flatten_reg_378;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp0_iter6_exitcond_flatten_reg_378;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp0_iter7_exitcond_flatten_reg_378;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp0_iter9_exitcond_flatten_reg_378;
    sc_signal< sc_lv<10> > indvar_flatten_next_fu_281_p2;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<6> > buff_addr_1_reg_387;
    sc_signal< sc_lv<6> > ap_pipeline_reg_pp0_iter1_buff_addr_1_reg_387;
    sc_signal< sc_lv<6> > ap_pipeline_reg_pp0_iter2_buff_addr_1_reg_387;
    sc_signal< sc_lv<6> > ap_pipeline_reg_pp0_iter3_buff_addr_1_reg_387;
    sc_signal< sc_lv<6> > ap_pipeline_reg_pp0_iter4_buff_addr_1_reg_387;
    sc_signal< sc_lv<6> > ap_pipeline_reg_pp0_iter5_buff_addr_1_reg_387;
    sc_signal< sc_lv<6> > ap_pipeline_reg_pp0_iter6_buff_addr_1_reg_387;
    sc_signal< sc_lv<6> > ap_pipeline_reg_pp0_iter7_buff_addr_1_reg_387;
    sc_signal< sc_lv<6> > ap_pipeline_reg_pp0_iter8_buff_addr_1_reg_387;
    sc_signal< sc_lv<6> > ap_pipeline_reg_pp0_iter9_buff_addr_1_reg_387;
    sc_signal< sc_lv<6> > i_2_fu_306_p2;
    sc_signal< sc_lv<32> > buff_q0;
    sc_signal< sc_lv<32> > buff_load_reg_398;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter1;
    sc_signal< sc_lv<32> > ap_pipeline_reg_pp0_iter2_buff_load_reg_398;
    sc_signal< sc_lv<32> > ap_pipeline_reg_pp0_iter3_buff_load_reg_398;
    sc_signal< sc_lv<32> > ap_pipeline_reg_pp0_iter4_buff_load_reg_398;
    sc_signal< sc_lv<32> > ap_pipeline_reg_pp0_iter5_buff_load_reg_398;
    sc_signal< sc_lv<32> > ap_pipeline_reg_pp0_iter6_buff_load_reg_398;
    sc_signal< sc_lv<32> > ap_pipeline_reg_pp0_iter7_buff_load_reg_398;
    sc_signal< sc_lv<32> > ap_pipeline_reg_pp0_iter8_buff_load_reg_398;
    sc_signal< sc_lv<32> > ap_pipeline_reg_pp0_iter9_buff_load_reg_398;
    sc_signal< sc_lv<32> > a2_sum3_fu_312_p2;
    sc_signal< sc_lv<32> > a2_sum3_reg_403;
    ...
    sc_signal< sc_lv<6> > i_reg_129;
    sc_signal< sc_lv<22> > cum_offs_reg_140;
    sc_signal< sc_lv<32> > i1_cast1_fu_301_p1;
    sc_signal< sc_lv<32> > a2_sum_cast_fu_231_p1;
    sc_signal< sc_logic > ap_reg_ioackin_A_BUS_ARREADY;
    sc_signal< sc_lv<29> > a1_fu_188_p4;
    sc_signal< sc_lv<31> > cum_offs_cast4_cast_fu_222_p1;
    sc_signal< sc_lv<22> > tmp_cast_fu_241_p1;
    sc_signal< sc_lv<22> > tmp_1_fu_245_p2;
    sc_signal< sc_lv<22> > tmp_2_cast_fu_266_p1;
    sc_signal< sc_lv<1> > exitcond5_fu_287_p2;
    sc_signal< sc_lv<6> > i1_mid2_fu_293_p3;
    sc_signal< sc_lv<32> > tmp_6_fu_323_p1;
    ...
    void thread_a1_fu_188_p4();
    void thread_a2_sum3_fu_312_p2();
    void thread_a2_sum_cast_fu_231_p1();
    void thread_a2_sum_fu_226_p2();
    ...
    void thread_cum_offs_1_fu_269_p2();
    void thread_cum_offs_cast4_cast_fu_222_p1();
    void thread_exitcond2_fu_210_p2();
    void thread_exitcond5_fu_287_p2();
    void thread_exitcond_flatten_fu_275_p2();
    void thread_i1_cast1_fu_301_p1();
    void thread_i1_mid2_fu_293_p3();
    void thread_i_1_fu_216_p2();
    void thread_i_2_fu_306_p2();
    void thread_i_cast2_fu_206_p1();
    void thread_indvar_flatten_next_fu_281_p2();
    void thread_tmp_1_fu_245_p2();
    void thread_tmp_2_cast_fu_266_p1();
    void thread_tmp_6_fu_323_p1();
    void thread_tmp_cast6_fu_202_p1();
