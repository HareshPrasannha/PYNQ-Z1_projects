...
if {[file isfile mod_data.autotvin.dat]} {
	file delete -force mod_data.autotvin.dat
}

if {[file isfile mod_data.autotvout.dat]} {
	file delete -force mod_data.autotvout.dat
}
