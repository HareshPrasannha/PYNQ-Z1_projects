...
`define AUTOTB_DUT      mod_data
`define AUTOTB_DUT_INST AESL_inst_mod_data
`define AUTOTB_TOP      apatb_mod_data_top
`define AUTOTB_LAT_RESULT_FILE "mod_data.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "mod_data.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_mod_data_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_A_BUS 1
`define AESL_DEPTH_a 1
`define AUTOTB_TVIN_A_BUS  "./c.mod_data.autotvin_A_BUS.dat"
`define AUTOTB_TVIN_a  "./c.mod_data.autotvin_a.dat"
`define AUTOTB_TVIN_A_BUS_out_wrapc  "./rtl.mod_data.autotvin_A_BUS.dat"
`define AUTOTB_TVIN_a_out_wrapc  "./rtl.mod_data.autotvin_a.dat"
`define AUTOTB_TVOUT_ap_return  "./c.mod_data.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.mod_data.autotvout_ap_return.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.mod_data.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.mod_data.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.mod_data.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.mod_data.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.mod_data.autotvout_ap_return.dat with impl_rtl.mod_data.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
