...
; [#uses=0]
define i32 @mod_data(i32* %a) nounwind readonly {
  call void (...)* @_ssdm_op_SpecBitsMap(i32* %a) nounwind, !map !55
  call void (...)* @_ssdm_op_SpecBitsMap(i32 0) nounwind, !map !61
  call void (...)* @_ssdm_op_SpecTopModule([9 x i8]* @mod_data.str) nounwind
  call void @llvm.dbg.value(metadata !{i32* %a}, i64 0, metadata !67), !dbg !68 ; [debug line = 6:19] [debug variable = a]
  call void (...)* @_ssdm_op_SpecInterface(i32* %a, [6 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 64000, [6 x i8]* @.str2, [6 x i8]* @.str3, [1 x i8]* @.str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !69 ; [debug line = 8:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !71 ; [debug line = 13:1]
  %a.addr = getelementptr inbounds i32* %a, i32 63984, !dbg !72 ; [#uses=1 type=i32*] [debug line = 20:4]
  %a.load = load i32* %a.addr, align 4, !dbg !72  ; [#uses=1 type=i32] [debug line = 20:4]
  %phitmp. = add i32 %a.load, 99, !dbg !75        ; [#uses=1 type=i32] [debug line = 17:25]
  ret i32 %phitmp., !dbg !76                      ; [debug line = 24:3]
}
...
!60 = metadata !{i32 0, i32 63999, i32 1}
...
!67 = metadata !{i32 786689, metadata !5, metadata !"a", metadata !6, i32 16777222, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!68 = metadata !{i32 6, i32 19, metadata !5, null}
...
!72 = metadata !{i32 20, i32 4, metadata !73, null}
!73 = metadata !{i32 786443, metadata !74, i32 17, i32 38, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!74 = metadata !{i32 786443, metadata !70, i32 17, i32 3, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!75 = metadata !{i32 17, i32 25, metadata !74, null}
!76 = metadata !{i32 24, i32 3, metadata !70, null}
