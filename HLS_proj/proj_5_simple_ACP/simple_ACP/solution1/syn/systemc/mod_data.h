...
#ifndef _mod_data_HH_
#define _mod_data_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "mod_data_AXILiteS_s_axi.h"
#include "mod_data_A_BUS_m_axi.h"
...
struct mod_data : public sc_module {
    ...
    // Module declarations
    mod_data(sc_module_name name);
    SC_HAS_PROCESS(mod_data);
    ...
    sc_signal< sc_lv<31> > a2_sum_fu_82_p2;
    sc_signal< sc_lv<31> > a2_sum_reg_103;
    sc_signal< sc_logic > ap_sig_ioackin_A_BUS_ARREADY;
    sc_signal< sc_lv<32> > A_BUS_addr_read_reg_114;
    sc_signal< sc_lv<32> > a2_sum_cast_fu_88_p1;
    sc_signal< sc_logic > ap_reg_ioackin_A_BUS_ARREADY;
    sc_signal< sc_lv<30> > tmp_fu_68_p4;
    sc_signal< sc_lv<31> > tmp_cast_fu_78_p1;
    ...
    static const sc_lv<31> ap_const_lv31_F9F0;
    ...
    void thread_a2_sum_cast_fu_88_p1();
    void thread_a2_sum_fu_82_p2();
    ...
    void thread_tmp_cast_fu_78_p1();
    void thread_tmp_fu_68_p4();
