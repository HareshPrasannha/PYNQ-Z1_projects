...
architecture behav of mod_data is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "mod_data,hls_ip_2016_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=9,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=692,HLS_SYN_LUT=818}";
    ...
    constant ap_const_lv31_F9F0 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000001111100111110000";
    ...
    signal a2_sum_fu_82_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal a2_sum_reg_103 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_sig_ioackin_A_BUS_ARREADY : STD_LOGIC;
    signal A_BUS_addr_read_reg_114 : STD_LOGIC_VECTOR (31 downto 0);
    signal a2_sum_cast_fu_88_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_reg_ioackin_A_BUS_ARREADY : STD_LOGIC := '0';
    signal tmp_fu_68_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_cast_fu_78_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_CS_fsm_state10 : STD_LOGIC_VECTOR (0 downto 0);
    attribute fsm_encoding of ap_CS_fsm_state10 : signal is "none";
    signal ap_NS_fsm : STD_LOGIC_VECTOR (9 downto 0);

    component mod_data_AXILiteS_s_axi IS
    generic (
    ...
    component mod_data_A_BUS_m_axi IS
    generic (
        USER_DW : INTEGER;
        USER_AW : INTEGER;
...
begin
    mod_data_AXILiteS_s_axi_U : component mod_data_AXILiteS_s_axi
    generic map (
    ...
    mod_data_A_BUS_m_axi_U : component mod_data_A_BUS_m_axi
    generic map (
        USER_DW => 32,
        USER_AW => 32,
        USER_MAXREQS => 5,
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, A_BUS_RVALID, ap_sig_ioackin_A_BUS_ARREADY)
    begin
        case ap_CS_fsm is
    ...
    A_BUS_ARVALID_assign_proc : process(ap_CS_fsm_state2, ap_reg_ioackin_A_BUS_ARREADY)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2) and (ap_const_logic_0 = ap_reg_ioackin_A_BUS_ARREADY))) then 
    ...
    A_BUS_RREADY_assign_proc : process(ap_CS_fsm_state9, A_BUS_RVALID)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state9) and not((A_BUS_RVALID = ap_const_logic_0)))) then 
    ...
    A_BUS_blk_n_AR_assign_proc : process(m_axi_A_BUS_ARREADY, ap_CS_fsm_state2)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2))) then 
    ...
    A_BUS_blk_n_R_assign_proc : process(m_axi_A_BUS_RVALID, ap_CS_fsm_state9)
    begin
    ...
    a2_sum_cast_fu_88_p1 <= std_logic_vector(resize(unsigned(a2_sum_reg_103),32));
    a2_sum_fu_82_p2 <= std_logic_vector(unsigned(tmp_cast_fu_78_p1) + unsigned(ap_const_lv31_F9F0));
    ...
    ap_return <= std_logic_vector(unsigned(A_BUS_addr_read_reg_114) + unsigned(ap_const_lv32_63));
    ...
    tmp_cast_fu_78_p1 <= std_logic_vector(resize(unsigned(tmp_fu_68_p4),31));
    tmp_fu_68_p4 <= a(31 downto 2);
end behav;
