...
$(ObjDir)/LL_prefetch_test.cpp_pre.cpp.tb.o : LL_prefetch_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling LL_prefetch_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/LL_prefetch.cpp_pre.cpp.tb.o : LL_prefetch.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling LL_prefetch.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
