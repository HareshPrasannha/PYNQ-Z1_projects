...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "LL_prefetch.autotvin.dat"
	set constFileTvOut       "LL_prefetch.autotvout.dat"
	set constFileHdlTvIn     "LL_prefetch.autohdltvin.dat"
	set constFileHdlTvOut    "LL_prefetch.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
