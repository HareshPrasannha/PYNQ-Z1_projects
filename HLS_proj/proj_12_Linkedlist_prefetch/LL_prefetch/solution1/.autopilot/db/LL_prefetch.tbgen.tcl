set C_TypeInfoList {{ 
"LL_prefetch" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[],{ "pointer": "0"}] }],[],""], 
"0": [ "node", {"struct": [[],[],[{ "val": [[32], "1"]},{ "offs": [[16], "2"]},{ "skip_offs": [[16], "2"]}],""]}], 
"1": [ "dat_typ", {"typedef": [[[], {"scalar": "int"}],""]}], 
"2": [ "dat_typ1", {"typedef": [[[], {"scalar": "short"}],""]}]
}}
set moduleName LL_prefetch
...
set NewPortList {[ 
	{ "name": "s_axi_CFG_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CFG", "role": "AWADDR" },"address":[{"name":"LL_prefetch","role":"start","value":"0","valid_bit":"0"},{"name":"LL_prefetch","role":"continue","value":"0","valid_bit":"4"},{"name":"LL_prefetch","role":"auto_start","value":"0","valid_bit":"7"},{"name":"a","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_CFG_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CFG", "role": "ARADDR" },"address":[{"name":"LL_prefetch","role":"start","value":"0","valid_bit":"0"},{"name":"LL_prefetch","role":"done","value":"0","valid_bit":"1"},{"name":"LL_prefetch","role":"idle","value":"0","valid_bit":"2"},{"name":"LL_prefetch","role":"ready","value":"0","valid_bit":"3"},{"name":"LL_prefetch","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.LL_prefetch_CFG_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.LL_prefetch_A_BUS_m_axi_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.buff_U", "Parent" : "0"}]}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "109876", "Max" : "109876"}
	, {"Name" : "Interval", "Min" : "109877", "Max" : "109877"}
]}
