...
set Library     "hls"
set IPName      "skipprefetch_Nelem"
set Version     "1.0"
set DisplayName "Skipprefetch_nelem"
set Revision    "2008171957"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "skipprefetch_Nelem"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_CFG m_axi_A_BUS m_axi_PREF_WINDOW"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_A_BUS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_A_BUS"
        data_width "64"
        param_prefix "C_M_AXI_A_BUS"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 64 WSTRB 8 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 64 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
                Width "8"
    ...
    m_axi_PREF_WINDOW {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_PREF_WINDOW"
        data_width "32"
        param_prefix "C_M_AXI_PREF_WINDOW"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 654 II x}
...
set enable_xo_gen 0
set kernel_files {A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj17_skipPreftch_Dyn_N/skipprefetch_Nelem.cpp}
if {$enable_xo_gen} {
