...
set IPName      "poll_ocm"
set Version     "1.0"
set DisplayName "Poll_ocm"
set Revision    "2004011246"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_ADDR_BUS m_axi_DATA_BUS"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_ADDR_BUS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_ADDR_BUS"
        data_width "32"
        param_prefix "C_M_AXI_ADDR_BUS"
    ...
    m_axi_DATA_BUS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DATA_BUS"
        data_width "32"
        param_prefix "C_M_AXI_DATA_BUS"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
set enable_xo_gen 0
set kernel_files {A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_6_Poll_ocm_fetch_ACP/poll_ocm.cpp}
if {$enable_xo_gen} {
