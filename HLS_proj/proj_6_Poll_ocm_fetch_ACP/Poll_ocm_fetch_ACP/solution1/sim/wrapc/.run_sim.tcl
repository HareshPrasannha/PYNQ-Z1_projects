...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "poll_ocm.autotvin.dat"
	set constFileTvOut       "poll_ocm.autotvout.dat"
	set constFileHdlTvIn     "poll_ocm.autohdltvin.dat"
	set constFileHdlTvOut    "poll_ocm.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
