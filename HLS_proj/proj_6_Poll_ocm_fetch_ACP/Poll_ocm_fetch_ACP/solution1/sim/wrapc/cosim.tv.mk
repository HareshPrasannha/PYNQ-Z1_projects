...
$(ObjDir)/poll_ocm_test.cpp_pre.cpp.tb.o : poll_ocm_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling poll_ocm_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/poll_ocm.cpp_pre.cpp.tb.o : poll_ocm.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling poll_ocm.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
