...
#ifndef __skipprefetch_NeledEe__HH__
#define __skipprefetch_NeledEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(skipprefetch_NeledEe) {
    ...
    SC_CTOR(skipprefetch_NeledEe):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
