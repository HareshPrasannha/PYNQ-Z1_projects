...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fetch_log.autotvin_A_BUS.dat"
         "c.fetch_log.autotvin_a.dat"
         "c.fetch_log.autotvin_log.dat"
         "c.fetch_log.autotvout_A_BUS.dat"
         "c.fetch_log.autotvout_LOG_BUS.dat"
         "c.fetch_log.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fetch_log.autotvout_A_BUS.dat"
         "rtl.fetch_log.autotvout_LOG_BUS.dat"
         "rtl.fetch_log.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
