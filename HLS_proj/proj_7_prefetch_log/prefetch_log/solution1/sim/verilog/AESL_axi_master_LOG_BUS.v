    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > LOG_BUS_mem_depth) begin
                $display ("A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_7_prefetch_log/prefetch_log/solution1/sim/verilog/AESL_axi_master_LOG_BUS.v: Write request address %d exceed AXI master LOG_BUS array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, LOG_BUS_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > LOG_BUS_mem_depth) begin
                $display ("A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_7_prefetch_log/prefetch_log/solution1/sim/verilog/AESL_axi_master_LOG_BUS.v: Read request address %d exceed AXI master LOG_BUS array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, LOG_BUS_mem_depth); 
                $finish;
            end
