...
//------------------------Parameter----------------------
`define TV_IN_A_BUS "../tv/cdatafile/c.fetch_log.autotvin_A_BUS.dat"
`define TV_OUT_A_BUS "../tv/rtldatafile/rtl.fetch_log.autotvout_A_BUS.dat"
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > A_BUS_mem_depth) begin
                $display ("A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_7_prefetch_log/prefetch_log/solution1/sim/verilog/AESL_axi_master_A_BUS.v: Write request address %d exceed AXI master A_BUS array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, A_BUS_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > A_BUS_mem_depth) begin
                $display ("A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_7_prefetch_log/prefetch_log/solution1/sim/verilog/AESL_axi_master_A_BUS.v: Read request address %d exceed AXI master A_BUS array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, A_BUS_mem_depth); 
                $finish;
            end
