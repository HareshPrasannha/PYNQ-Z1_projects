...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fetch_log.autotvin.dat"
	set constFileTvOut       "fetch_log.autotvout.dat"
	set constFileHdlTvIn     "fetch_log.autohdltvin.dat"
	set constFileHdlTvOut    "fetch_log.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
