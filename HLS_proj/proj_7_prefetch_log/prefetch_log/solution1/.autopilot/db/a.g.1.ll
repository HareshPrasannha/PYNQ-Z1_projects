; ModuleID = 'A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_7_prefetch_log/prefetch_log/solution1/.autopilot/db/a.g.1.bc'
...
; <label>:1                                       ; preds = %2, %0
  %ret_val = phi i32 [ 0, %0 ], [ %.ret_val, %2 ] ; [#uses=2 type=i32]
...
; <label>:2                                       ; preds = %1
  %a.addr = getelementptr inbounds i32* %a, i32 %i, !dbg !62 ; [#uses=2 type=i32*] [debug line = 13:4]
  ...
  %ret_val.1 = add nsw i32 %temp, 10, !dbg !65    ; [#uses=2 type=i32] [debug line = 14:4]
  store i32 %ret_val.1, i32* %a.addr, align 4, !dbg !65 ; [debug line = 14:4]
  store i32 %i, i32* %log, align 4, !dbg !66      ; [debug line = 15:4]
  %tmp.2 = icmp eq i32 %i, 16, !dbg !67           ; [#uses=1 type=i1] [debug line = 16:4]
  call void @llvm.dbg.value(metadata !{i32 %ret_val.1}, i64 0, metadata !68), !dbg !69 ; [debug line = 17:5] [debug variable = ret_val]
  %.ret_val = select i1 %tmp.2, i32 %ret_val.1, i32 %ret_val, !dbg !67 ; [#uses=1 type=i32] [debug line = 16:4]
  %i.1 = add nsw i32 %i, 8, !dbg !70              ; [#uses=1 type=i32] [debug line = 11:24]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !71), !dbg !70 ; [debug line = 11:24] [debug variable = i]
  br label %1, !dbg !70                           ; [debug line = 11:24]

; <label>:3                                       ; preds = %1
  %ret_val.0.lcssa = phi i32 [ %ret_val, %1 ]     ; [#uses=1 type=i32]
  ret i32 %ret_val.0.lcssa, !dbg !72              ; [debug line = 19:3]
}
...
!65 = metadata !{i32 14, i32 4, metadata !63, null}
!66 = metadata !{i32 15, i32 4, metadata !63, null}
!67 = metadata !{i32 16, i32 4, metadata !63, null}
!68 = metadata !{i32 786688, metadata !57, metadata !"ret_val", metadata !6, i32 10, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!69 = metadata !{i32 17, i32 5, metadata !63, null}
!70 = metadata !{i32 11, i32 24, metadata !61, null}
!71 = metadata !{i32 786688, metadata !61, metadata !"i", metadata !6, i32 11, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!72 = metadata !{i32 19, i32 3, metadata !57, null}
