...
if {[file isfile fetch_log.autotvin.dat]} {
	file delete -force fetch_log.autotvin.dat
}

if {[file isfile fetch_log.autotvout.dat]} {
	file delete -force fetch_log.autotvout.dat
}
