...
//------------------------Parameter----------------------
`define TV_IN_LOG_BUS "../tv/cdatafile/c.fetch_log.autotvin_LOG_BUS.dat"
`define TV_OUT_LOG_BUS "../tv/rtldatafile/rtl.fetch_log.autotvout_LOG_BUS.dat"
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > LOG_BUS_mem_depth) begin
                $display ("A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_8_Pureprefetch_log/Pure_prefetch_log/solution1/sim/verilog/AESL_axi_master_LOG_BUS.v: Write request address %d exceed AXI master LOG_BUS array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, LOG_BUS_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > LOG_BUS_mem_depth) begin
                $display ("A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_8_Pureprefetch_log/Pure_prefetch_log/solution1/sim/verilog/AESL_axi_master_LOG_BUS.v: Read request address %d exceed AXI master LOG_BUS array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, LOG_BUS_mem_depth); 
                $finish;
            end
