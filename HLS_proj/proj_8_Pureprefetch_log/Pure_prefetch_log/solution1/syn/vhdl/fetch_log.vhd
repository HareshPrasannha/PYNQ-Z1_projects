...
architecture behav of fetch_log is 
    ...
    "fetch_log,hls_ip_2016_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=80001,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=1385,HLS_SYN_LUT=1539}";
    ...
    signal LOG_BUS_addr_reg_206 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_cast_fu_162_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_2_cast_reg_211 : STD_LOGIC_VECTOR (30 downto 0);
    signal i_cast1_fu_166_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_cast1_reg_216 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_ioackin_LOG_BUS_AWREADY : STD_LOGIC;
    signal a2_sum_fu_180_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal a2_sum_reg_224 : STD_LOGIC_VECTOR (30 downto 0);
    signal i_1_fu_185_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal i_1_reg_229 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal sum_1_fu_201_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state11 : STD_LOGIC_VECTOR (0 downto 0);
    attribute fsm_encoding of ap_CS_fsm_state11 : signal is "none";
    signal sum_reg_109 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_reg_121 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_1_fu_142_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal a2_sum_cast_fu_191_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal log3_fu_132_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_2_fu_152_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal i_cast1_cast_fu_170_p1 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((tmp_fu_174_p2 = ap_const_lv1_0)))) then
                    if (not((not((tmp_fu_174_p2 = ap_const_lv1_0)) and (ap_const_logic_0 = ap_sig_ioackin_LOG_BUS_AWREADY)))) then 
                        ap_reg_ioackin_LOG_BUS_AWREADY <= ap_const_logic_0;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_CS_fsm_state1 = ap_const_lv1_1) and not((ap_start = ap_const_logic_0)))) then
                    LOG_BUS_addr_reg_206(29 downto 0) <= tmp_1_fu_142_p1(29 downto 0);
                    tmp_2_cast_reg_211(29 downto 0) <= tmp_2_cast_fu_162_p1(29 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((tmp_fu_174_p2 = ap_const_lv1_0)) and not((not((tmp_fu_174_p2 = ap_const_lv1_0)) and (ap_const_logic_0 = ap_sig_ioackin_LOG_BUS_AWREADY))))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((not((tmp_fu_174_p2 = ap_const_lv1_0)) and (ap_const_logic_0 = ap_sig_ioackin_LOG_BUS_AWREADY))))) then
                    i_cast1_reg_216(15 downto 0) <= i_cast1_fu_166_p1(15 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    LOG_BUS_addr_reg_206(31 downto 30) <= "00";
    tmp_2_cast_reg_211(30) <= '0';
    i_cast1_reg_216(31 downto 16) <= "0000000000000000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, tmp_fu_174_p2, A_BUS_RVALID, LOG_BUS_BVALID, ap_sig_ioackin_LOG_BUS_AWREADY, ap_sig_ioackin_A_BUS_ARREADY, ap_sig_ioackin_LOG_BUS_WREADY)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((tmp_fu_174_p2 = ap_const_lv1_0) and not((not((tmp_fu_174_p2 = ap_const_lv1_0)) and (ap_const_logic_0 = ap_sig_ioackin_LOG_BUS_AWREADY))))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                elsif ((not((tmp_fu_174_p2 = ap_const_lv1_0)) and not((not((tmp_fu_174_p2 = ap_const_lv1_0)) and (ap_const_logic_0 = ap_sig_ioackin_LOG_BUS_AWREADY))))) then
            ...
            when ap_ST_fsm_state8 => 
                if (not((LOG_BUS_BVALID = ap_const_logic_0))) then
    ...
    LOG_BUS_AWVALID_assign_proc : process(ap_CS_fsm_state2, tmp_fu_174_p2, ap_reg_ioackin_LOG_BUS_AWREADY)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((tmp_fu_174_p2 = ap_const_lv1_0)) and (ap_const_logic_0 = ap_reg_ioackin_LOG_BUS_AWREADY))) then 
    ...
    LOG_BUS_BREADY_assign_proc : process(ap_CS_fsm_state8, LOG_BUS_BVALID)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state8) and not((LOG_BUS_BVALID = ap_const_logic_0)))) then 
    ...
    LOG_BUS_blk_n_AW_assign_proc : process(m_axi_LOG_BUS_AWREADY, ap_CS_fsm_state2, tmp_fu_174_p2)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((tmp_fu_174_p2 = ap_const_lv1_0)))) then 
    ...
    a2_sum_cast_fu_191_p1 <= std_logic_vector(resize(unsigned(a2_sum_reg_224),32));
    a2_sum_fu_180_p2 <= std_logic_vector(unsigned(tmp_2_cast_reg_211) + unsigned(i_cast1_cast_fu_170_p1));
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state2, tmp_fu_174_p2, ap_sig_ioackin_LOG_BUS_AWREADY)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_174_p2 = ap_const_lv1_0) and not((not((tmp_fu_174_p2 = ap_const_lv1_0)) and (ap_const_logic_0 = ap_sig_ioackin_LOG_BUS_AWREADY))))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, tmp_fu_174_p2, ap_sig_ioackin_LOG_BUS_AWREADY)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_174_p2 = ap_const_lv1_0) and not((not((tmp_fu_174_p2 = ap_const_lv1_0)) and (ap_const_logic_0 = ap_sig_ioackin_LOG_BUS_AWREADY))))) then 
    ...
    i_1_fu_185_p2 <= std_logic_vector(unsigned(i_reg_121) + unsigned(ap_const_lv16_8));
    i_cast1_cast_fu_170_p1 <= std_logic_vector(resize(unsigned(i_reg_121),31));
    i_cast1_fu_166_p1 <= std_logic_vector(resize(unsigned(i_reg_121),32));
    log3_fu_132_p4 <= log(31 downto 2);
    sum_1_fu_201_p2 <= std_logic_vector(unsigned(temp_reg_240) + unsigned(sum_reg_109));
    tmp_1_fu_142_p1 <= std_logic_vector(resize(unsigned(log3_fu_132_p4),32));
    tmp_2_cast_fu_162_p1 <= std_logic_vector(resize(unsigned(tmp_2_fu_152_p4),31));
    tmp_2_fu_152_p4 <= a(31 downto 2);
    tmp_fu_174_p2 <= "1" when (unsigned(i_reg_121) < unsigned(ap_const_lv16_FA00)) else "0";
end behav;
