; ModuleID = 'A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_8_Pureprefetch_log/Pure_prefetch_log/solution1/.autopilot/db/a.o.2.bc'
...
; <label>:3                                       ; preds = %1
  %a.addr = getelementptr inbounds i32* %a, i32 %i.cast1, !dbg !79 ; [#uses=1 type=i32*] [debug line = 13:4]
  ...
  %sum.1 = add nsw i32 %sum, %temp, !dbg !82      ; [#uses=1 type=i32] [debug line = 15:4]
  call void @llvm.dbg.value(metadata !{i32 %sum.1}, i64 0, metadata !83), !dbg !82 ; [debug line = 15:4] [debug variable = sum]
  store i32 %i.cast1, i32* %log, align 4, !dbg !84 ; [debug line = 16:4]
  %i.1 = add i16 %i, 8, !dbg !85                  ; [#uses=1 type=i16] [debug line = 11:24]
  call void @llvm.dbg.value(metadata !{i16 %i.1}, i64 0, metadata !86), !dbg !85 ; [debug line = 11:24] [debug variable = i]
  br label %1, !dbg !85                           ; [debug line = 11:24]

; <label>:4                                       ; preds = %1
  %sum.lcssa = phi i32 [ %sum, %1 ]               ; [#uses=1 type=i32]
  ret i32 %sum.lcssa, !dbg !87                    ; [debug line = 21:3]
}
...
!82 = metadata !{i32 15, i32 4, metadata !80, null}
!83 = metadata !{i32 786688, metadata !74, metadata !"sum", metadata !6, i32 10, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!84 = metadata !{i32 16, i32 4, metadata !80, null}
!85 = metadata !{i32 11, i32 24, metadata !78, null}
!86 = metadata !{i32 786688, metadata !78, metadata !"i", metadata !6, i32 11, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!87 = metadata !{i32 21, i32 3, metadata !74, null}
