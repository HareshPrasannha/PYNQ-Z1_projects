; ModuleID = 'A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_8_Pureprefetch_log/Pure_prefetch_log/solution1/.autopilot/db/a.o.3.bc'
...
; <label>:1                                       ; preds = %2, %0
  %sum = phi i32 [ 0, %0 ], [ %sum_1, %2 ]        ; [#uses=2 type=i32]
  %i = phi i16 [ 0, %0 ], [ %i_1, %2 ]            ; [#uses=4 type=i16]
...
; <label>:2                                       ; preds = %1
  %a2_sum = add i31 %tmp_2_cast, %i_cast1_cast, !dbg !58 ; [#uses=1 type=i31] [debug line = 13:4]
  %a2_sum_cast = zext i31 %a2_sum to i32, !dbg !58 ; [#uses=1 type=i32] [debug line = 13:4]
  %A_BUS_addr = getelementptr inbounds i32* %A_BUS, i32 %a2_sum_cast, !dbg !58 ; [#uses=2 type=i32*] [debug line = 13:4]
  ...
  %sum_1 = add nsw i32 %temp, %sum, !dbg !61      ; [#uses=1 type=i32] [debug line = 15:4]
  call void @llvm.dbg.value(metadata !{i32 %sum_1}, i64 0, metadata !62), !dbg !61 ; [debug line = 15:4] [debug variable = sum]
  %LOG_BUS_addr_req = call i1 @_ssdm_op_WriteReq.m_axi.i32P(i32* %LOG_BUS_addr, i32 1), !dbg !63 ; [#uses=0 type=i1] [debug line = 16:4]
  call void @_ssdm_op_Write.m_axi.i32P(i32* %LOG_BUS_addr, i32 %i_cast1, i4 -1), !dbg !63 ; [debug line = 16:4]
  %LOG_BUS_addr_resp = call i1 @_ssdm_op_WriteResp.m_axi.i32P(i32* %LOG_BUS_addr), !dbg !63 ; [#uses=0 type=i1] [debug line = 16:4]
  %i_1 = add i16 %i, 8, !dbg !64                  ; [#uses=1 type=i16] [debug line = 11:24]
  call void @llvm.dbg.value(metadata !{i16 %i_1}, i64 0, metadata !65), !dbg !64 ; [debug line = 11:24] [debug variable = i]
  br label %1, !dbg !64                           ; [debug line = 11:24]

; <label>:3                                       ; preds = %1
  ret i32 %sum, !dbg !66                          ; [debug line = 21:3]
}
...
!26 = metadata !{i32 786473, metadata !"Pureprefetch_log.cpp", metadata !"A:\5CCOMP_ARCH\5CPYNQ_Projects\5CHLS_proj\5Cproj_8_Pureprefetch_log", null} ; [ DW_TAG_file_type ]
...
!61 = metadata !{i32 15, i32 4, metadata !59, null}
!62 = metadata !{i32 786688, metadata !53, metadata !"sum", metadata !26, i32 10, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!63 = metadata !{i32 16, i32 4, metadata !59, null}
!64 = metadata !{i32 11, i32 24, metadata !57, null}
!65 = metadata !{i32 786688, metadata !57, metadata !"i", metadata !26, i32 11, metadata !29, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!66 = metadata !{i32 21, i32 3, metadata !53, null}
