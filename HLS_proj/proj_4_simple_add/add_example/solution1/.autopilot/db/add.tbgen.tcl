set C_TypeInfoList {{ 
"add" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"a": [[],{ "pointer":  {"scalar": "int"}}] }],[],""]
}}
set moduleName add
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"add","role":"start","value":"0","valid_bit":"0"},{"name":"add","role":"continue","value":"0","valid_bit":"4"},{"name":"add","role":"auto_start","value":"0","valid_bit":"7"},{"name":"a","role":"data","value":"24"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.add_A_BUS_m_axi_U", "Parent" : "0"}]}
