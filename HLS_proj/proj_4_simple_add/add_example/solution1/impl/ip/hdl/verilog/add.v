...
(* CORE_GENERATION_INFO="add,hls_ip_2016_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=21,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=788,HLS_SYN_LUT=948}" *)
...
parameter    ap_const_lv16_7D00 = 16'b111110100000000;
...
wire   [30:0] tmp_1_cast_fu_111_p1;
reg   [30:0] tmp_1_cast_reg_170;
wire   [30:0] a2_sum_fu_131_p2;
reg   [30:0] a2_sum_reg_178;
wire   [0:0] ap_CS_fsm_state2;
wire   [0:0] tmp_fu_115_p2;
wire   [0:0] tmp_1_2_fu_136_p2;
reg   [0:0] tmp_1_2_reg_183;
wire   [15:0] i_1_1_fu_142_p2;
reg   [15:0] i_1_1_reg_188;
reg    ap_sig_ioackin_A_BUS_ARREADY;
reg   [31:0] A_BUS_addr_read_reg_199;
wire   [31:0] ret_val_1_2_fu_163_p3;
wire   [0:0] ap_CS_fsm_state11;
reg   [31:0] ret_val_reg_78;
reg   [15:0] i_reg_90;
wire   [31:0] a2_sum_cast_fu_148_p1;
reg    ap_reg_ioackin_A_BUS_ARREADY;
wire   [29:0] tmp_1_fu_101_p4;
wire   [15:0] i_1_s_fu_121_p2;
wire   [30:0] i_1_cast_cast_fu_127_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & ~(tmp_fu_115_p2 == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_CS_fsm_state1 == 1'b1) & ~(ap_start == 1'b0))) begin
        tmp_1_cast_reg_170[29 : 0] <= tmp_1_cast_fu_111_p1[29 : 0];
    end
end
...
assign a2_sum_cast_fu_148_p1 = a2_sum_reg_178;

assign a2_sum_fu_131_p2 = (i_1_cast_cast_fu_127_p1 + tmp_1_cast_reg_170);
...
assign i_1_1_fu_142_p2 = (i_reg_90 + ap_const_lv16_7D00);

assign i_1_cast_cast_fu_127_p1 = i_1_s_fu_121_p2;

assign i_1_s_fu_121_p2 = (i_reg_90 | ap_const_lv16_10);

assign ret_val_1_2_fu_163_p3 = ((tmp_1_2_reg_183[0:0] === 1'b1) ? ret_val_2_2_fu_158_p2 : ret_val_reg_78);

assign ret_val_2_2_fu_158_p2 = (A_BUS_addr_read_reg_199 + ap_const_lv32_A);

assign tmp_1_2_fu_136_p2 = ((i_reg_90 == ap_const_lv16_0) ? 1'b1 : 1'b0);

assign tmp_1_cast_fu_111_p1 = tmp_1_fu_101_p4;

assign tmp_1_fu_101_p4 = {{a[ap_const_lv32_1F : ap_const_lv32_2]}};

assign tmp_fu_115_p2 = ((i_reg_90 < ap_const_lv16_FA00) ? 1'b1 : 1'b0);

always @ (posedge ap_clk) begin
    tmp_1_cast_reg_170[30] <= 1'b0;
end
