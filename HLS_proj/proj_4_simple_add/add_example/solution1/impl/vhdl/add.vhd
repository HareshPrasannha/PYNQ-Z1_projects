...
architecture behav of add is 
    ...
    "add,hls_ip_2016_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.750000,HLS_SYN_LAT=21,HLS_SYN_TPT=none,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=788,HLS_SYN_LUT=948}";
    ...
    signal tmp_1_cast_fu_111_p1 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_1_cast_reg_170 : STD_LOGIC_VECTOR (30 downto 0);
    signal a2_sum_fu_131_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal a2_sum_reg_178 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC_VECTOR (0 downto 0);
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_fu_115_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1_2_fu_136_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_1_2_reg_183 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_1_1_fu_142_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal i_1_1_reg_188 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_sig_ioackin_A_BUS_ARREADY : STD_LOGIC;
    signal A_BUS_addr_read_reg_199 : STD_LOGIC_VECTOR (31 downto 0);
    signal ret_val_1_2_fu_163_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state11 : STD_LOGIC_VECTOR (0 downto 0);
    attribute fsm_encoding of ap_CS_fsm_state11 : signal is "none";
    signal ret_val_reg_78 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_reg_90 : STD_LOGIC_VECTOR (15 downto 0);
    signal a2_sum_cast_fu_148_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_reg_ioackin_A_BUS_ARREADY : STD_LOGIC := '0';
    signal tmp_1_fu_101_p4 : STD_LOGIC_VECTOR (29 downto 0);
    signal i_1_s_fu_121_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal i_1_cast_cast_fu_127_p1 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    port map (
        ...
        ap_done => ap_done,
        ap_idle => ap_idle,
        ap_return => ret_val_reg_78,
        a => a);

    add_A_BUS_m_axi_U : component add_A_BUS_m_axi
    generic map (
        USER_DW => 32,
        USER_AW => 32,
        USER_MAXREQS => 5,
    ...
    port map (
        ...
        I_ARADDR => a2_sum_cast_fu_148_p1,
    ...
    ret_val_reg_78_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state11))) then 
                ret_val_reg_78 <= ret_val_1_2_fu_163_p3;
            elsif (((ap_CS_fsm_state1 = ap_const_lv1_1) and not((ap_start = ap_const_logic_0)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state10) and not((A_BUS_RVALID = ap_const_logic_0)))) then
                A_BUS_addr_read_reg_199 <= A_BUS_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_state2) and not((tmp_fu_115_p2 = ap_const_lv1_0)))) then
                a2_sum_reg_178 <= a2_sum_fu_131_p2;
                i_1_1_reg_188 <= i_1_1_fu_142_p2;
                tmp_1_2_reg_183 <= tmp_1_2_fu_136_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_CS_fsm_state1 = ap_const_lv1_1) and not((ap_start = ap_const_logic_0)))) then
                    tmp_1_cast_reg_170(29 downto 0) <= tmp_1_cast_fu_111_p1(29 downto 0);
            end if;
        end if;
    end process;
    tmp_1_cast_reg_170(30) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, A_BUS_RVALID, tmp_fu_115_p2, ap_sig_ioackin_A_BUS_ARREADY)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if ((tmp_fu_115_p2 = ap_const_lv1_0)) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    a2_sum_cast_fu_148_p1 <= std_logic_vector(resize(unsigned(a2_sum_reg_178),32));
    a2_sum_fu_131_p2 <= std_logic_vector(unsigned(i_1_cast_cast_fu_127_p1) + unsigned(tmp_1_cast_reg_170));
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state2, tmp_fu_115_p2)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_115_p2 = ap_const_lv1_0))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, tmp_fu_115_p2)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_state2) and (tmp_fu_115_p2 = ap_const_lv1_0))) then 
    ...
    i_1_1_fu_142_p2 <= std_logic_vector(unsigned(i_reg_90) + unsigned(ap_const_lv16_7D00));
    i_1_cast_cast_fu_127_p1 <= std_logic_vector(resize(unsigned(i_1_s_fu_121_p2),31));
    i_1_s_fu_121_p2 <= (i_reg_90 or ap_const_lv16_10);
    ret_val_1_2_fu_163_p3 <= 
        ret_val_2_2_fu_158_p2 when (tmp_1_2_reg_183(0) = '1') else 
        ret_val_reg_78;
    ret_val_2_2_fu_158_p2 <= std_logic_vector(unsigned(A_BUS_addr_read_reg_199) + unsigned(ap_const_lv32_A));
    tmp_1_2_fu_136_p2 <= "1" when (i_reg_90 = ap_const_lv16_0) else "0";
    tmp_1_cast_fu_111_p1 <= std_logic_vector(resize(unsigned(tmp_1_fu_101_p4),31));
    tmp_1_fu_101_p4 <= a(31 downto 2);
    tmp_fu_115_p2 <= "1" when (unsigned(i_reg_90) < unsigned(ap_const_lv16_FA00)) else "0";
end behav;
