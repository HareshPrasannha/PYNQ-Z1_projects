...
architecture behave of add_CRTL_BUS_s_axi is
    ...
    signal int_gain            : UNSIGNED(31 downto 0);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_GAIN_DATA_0 =>
                        rdata_data <= RESIZE(int_gain(31 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    gain                 <= STD_LOGIC_VECTOR(int_gain);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_GAIN_DATA_0) then
                    int_gain(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_gain(31 downto 0));
                end if;
            end if;
        end if;
    end process;
