...
// wrapc file define: "gain"
#define AUTOTB_TVIN_gain  "../tv/cdatafile/c.add.autotvin_gain.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "outStream_V_data_V"
#define AUTOTB_TVOUT_PC_outStream_V_data_V  "../tv/rtldatafile/rtl.add.autotvout_outStream_V_data_V.dat"
// tvout file define: "outStream_V_keep_V"
#define AUTOTB_TVOUT_PC_outStream_V_keep_V  "../tv/rtldatafile/rtl.add.autotvout_outStream_V_keep_V.dat"
// tvout file define: "outStream_V_strb_V"
#define AUTOTB_TVOUT_PC_outStream_V_strb_V  "../tv/rtldatafile/rtl.add.autotvout_outStream_V_strb_V.dat"
// tvout file define: "outStream_V_user_V"
#define AUTOTB_TVOUT_PC_outStream_V_user_V  "../tv/rtldatafile/rtl.add.autotvout_outStream_V_user_V.dat"
// tvout file define: "outStream_V_last_V"
#define AUTOTB_TVOUT_PC_outStream_V_last_V  "../tv/rtldatafile/rtl.add.autotvout_outStream_V_last_V.dat"
// tvout file define: "outStream_V_id_V"
#define AUTOTB_TVOUT_PC_outStream_V_id_V  "../tv/rtldatafile/rtl.add.autotvout_outStream_V_id_V.dat"
// tvout file define: "outStream_V_dest_V"
#define AUTOTB_TVOUT_PC_outStream_V_dest_V  "../tv/rtldatafile/rtl.add.autotvout_outStream_V_dest_V.dat"
...
extern void add (
hls::stream<ap_axis<32, 2, 5, 6 > >& inStream,
hls::stream<ap_axis<32, 2, 5, 6 > >& outStream,
int gain);
...
int gain)
{
	...
	else
	{
		...
		// "gain"
		char* tvin_gain = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_gain);
		...
		// [[transaction]]
		sprintf(tvin_gain, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_gain, tvin_gain);

		sc_bv<32> gain_tvin_wrapc_buffer;
			...
			// bitslice(31, 0)
			{
				// celement: gain(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						// ori_name              : gain
						// sub_1st_elem          : 
						// ori_name_1st_elem     : gain
						// regulate_c_name       : gain
						// input_type_conversion : gain
						if (&(gain) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> gain_tmp_mem;
							gain_tmp_mem = gain;
							gain_tvin_wrapc_buffer.range(31, 0) = gain_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_gain, "%s\n", (gain_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_gain, tvin_gain);
		}

		tcl_file.set_num(1, &tcl_file.gain_depth);
		sprintf(tvin_gain, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_gain, tvin_gain);
...
// [call_c_dut] ---------->
     ...
     aesl_tmp_3.clear();
		...
		// release memory allocation: "gain"
		delete [] tvin_gain;
