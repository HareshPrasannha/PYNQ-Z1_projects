set C_TypeInfoList {{ 
"add" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inStream": [[], {"reference": "0"}] }, {"outStream": [[], {"reference": "0"}] }, {"gain": [[], {"scalar": "int"}] }],[],""], 
...
set NewPortList {[ 
	{ "name": "s_axi_CRTL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CRTL_BUS", "role": "AWADDR" },"address":[{"name":"add","role":"start","value":"0","valid_bit":"0"},{"name":"add","role":"continue","value":"0","valid_bit":"4"},{"name":"add","role":"auto_start","value":"0","valid_bit":"7"},{"name":"gain","role":"data","value":"16"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.add_CRTL_BUS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.add_mul_32s_32s_3bkb_U0", "Parent" : "0"}]}
