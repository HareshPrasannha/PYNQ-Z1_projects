...
entity read_ocm_CTRL_BUS_s_axi is
generic (
...
end entity read_ocm_CTRL_BUS_s_axi;
...
architecture behave of read_ocm_CTRL_BUS_s_axi is
    type states is (wridle, wrdata, wrresp, rdidle, rddata);  -- read and write fsm states
    signal wstate, wnext, rstate, rnext: states;
    constant ADDR_START_DATA_0 : INTEGER := 16#10#;
    constant ADDR_START_CTRL   : INTEGER := 16#14#;
    ...
    -- internal registers
    signal int_start           : UNSIGNED(31 downto 0);
