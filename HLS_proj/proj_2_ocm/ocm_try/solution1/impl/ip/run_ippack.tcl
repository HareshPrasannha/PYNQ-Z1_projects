...
set IPName      "read_ocm"
set Version     "1.0"
set DisplayName "Read_ocm"
set Revision    "2003261209"
...
set Interfaces {
    ...
    s_axi_CTRL_BUS {
        ...
        addr_bits "5"
        port_width "AWADDR 5 WDATA 32 WSTRB 4 ARADDR 5 RDATA 32"
        registers {{0x10 start W 0x0 "Data signal of start" {{0 32 start W 0 "Bit 31 to 0 Data signal of start"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axi_CTRL_BUS m_axi_SOURCE_BUS"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_SOURCE_BUS {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_SOURCE_BUS"
        data_width "32"
        param_prefix "C_M_AXI_SOURCE_BUS"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 1 II x}
...
set enable_xo_gen 0
set kernel_files {A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_2_ocm/read_ocm.cpp}
if {$enable_xo_gen} {
