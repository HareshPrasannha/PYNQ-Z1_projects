...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.read_ocm.autotvin_SOURCE_BUS.dat"
         "c.read_ocm.autotvin_source.dat"
         "c.read_ocm.autotvin_start.dat"
         "c.read_ocm.autotvout_SOURCE_BUS.dat"
         "c.read_ocm.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.read_ocm.autotvout_SOURCE_BUS.dat"
         "rtl.read_ocm.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
