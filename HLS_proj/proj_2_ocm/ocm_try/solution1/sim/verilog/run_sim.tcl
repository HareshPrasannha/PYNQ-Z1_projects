...
if {[file isfile read_ocm.autotvin.dat]} {
	file delete -force read_ocm.autotvin.dat
}

if {[file isfile read_ocm.autotvout.dat]} {
	file delete -force read_ocm.autotvout.dat
}
