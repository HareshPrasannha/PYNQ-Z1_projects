...
$(ObjDir)/read_ocm_test.cpp_pre.cpp.tb.o : read_ocm_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling read_ocm_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/read_ocm.cpp_pre.cpp.tb.o : read_ocm.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling read_ocm.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
