...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "read_ocm.autotvin.dat"
	set constFileTvOut       "read_ocm.autotvout.dat"
	set constFileHdlTvIn     "read_ocm.autohdltvin.dat"
	set constFileHdlTvOut    "read_ocm.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
