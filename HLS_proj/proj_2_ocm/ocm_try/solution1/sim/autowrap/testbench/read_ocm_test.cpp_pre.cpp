# 1 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_2_ocm/read_ocm_test.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_2_ocm/read_ocm_test.cpp"
...
# 4 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_2_ocm/read_ocm_test.cpp" 2
...
int main()
{
 ...
 int *a ;
 a = &b;
# 36 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_2_ocm/read_ocm_test.cpp"
 int status = read_ocm(a,1);

 printf("Status value:%d\n",status);
 printf("Done\n");
# 55 "A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_2_ocm/read_ocm_test.cpp"
 return 0;
}
