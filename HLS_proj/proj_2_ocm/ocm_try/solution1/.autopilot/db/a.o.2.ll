...
define i32 @read_ocm(i32* %source, i32 %start) nounwind {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap(i32 %start) nounwind, !map !34
  call void (...)* @_ssdm_op_SpecBitsMap(i32 0) nounwind, !map !40
  call void (...)* @_ssdm_op_SpecTopModule([9 x i8]* @read_ocm.str) nounwind
  call void @llvm.dbg.value(metadata !{i32* %source}, i64 0, metadata !46), !dbg !47 ; [debug line = 4:19] [debug variable = source]
  call void @llvm.dbg.value(metadata !{i32 %start}, i64 0, metadata !48), !dbg !49 ; [debug line = 4:31] [debug variable = start]
  call void (...)* @_ssdm_op_SpecInterface(i32* %source, [6 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [11 x i8]* @.str2, [6 x i8]* @.str3, [1 x i8]* @.str1, i32 16, i32 16, i32 16, i32 16, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !50 ; [debug line = 6:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %start, [10 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [9 x i8]* @.str5, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !52 ; [debug line = 8:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @.str4, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind, !dbg !53 ; [debug line = 10:1]
  %tmp = icmp eq i32 %start, 1, !dbg !54          ; [#uses=1 type=i1] [debug line = 12:2]
  br i1 %tmp, label %1, label %._crit_edge, !dbg !54 ; [debug line = 12:2]

; <label>:1                                       ; preds = %0
  call void @llvm.dbg.value(metadata !{i32* %source}, i64 0, metadata !55), !dbg !57 ; [debug line = 14:3] [debug variable = buff]
  %source.load = load i32* %source, align 4, !dbg !58 ; [#uses=1 type=i32] [debug line = 15:3]
  %tmp.1 = add nsw i32 %source.load, 10, !dbg !58 ; [#uses=2 type=i32] [debug line = 15:3]
  store i32 %tmp.1, i32* %source, align 4, !dbg !58 ; [debug line = 15:3]
  br label %._crit_edge, !dbg !59                 ; [debug line = 16:3]

._crit_edge:                                      ; preds = %1, %0
  %.0 = phi i32 [ %tmp.1, %1 ], [ -1, %0 ]        ; [#uses=1 type=i32]
  ret i32 %.0, !dbg !60                           ; [debug line = 21:1]
}
...
!37 = metadata !{metadata !"start", metadata !38, metadata !"int", i32 0, i32 31}
...
!46 = metadata !{i32 786689, metadata !5, metadata !"source", metadata !6, i32 16777220, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!47 = metadata !{i32 4, i32 19, metadata !5, null}
!48 = metadata !{i32 786689, metadata !5, metadata !"start", metadata !6, i32 33554436, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!49 = metadata !{i32 4, i32 31, metadata !5, null}
...
!52 = metadata !{i32 8, i32 1, metadata !51, null}
!53 = metadata !{i32 10, i32 1, metadata !51, null}
!54 = metadata !{i32 12, i32 2, metadata !51, null}
!55 = metadata !{i32 786688, metadata !56, metadata !"buff", metadata !6, i32 13, metadata !10, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!56 = metadata !{i32 786443, metadata !51, i32 12, i32 16, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!57 = metadata !{i32 14, i32 3, metadata !56, null}
!58 = metadata !{i32 15, i32 3, metadata !56, null}
!59 = metadata !{i32 16, i32 3, metadata !56, null}
!60 = metadata !{i32 21, i32 1, metadata !51, null}
