...
entity read_ocm_AXILiteS_s_axi is
generic (
...
end entity read_ocm_AXILiteS_s_axi;
...
architecture behave of read_ocm_AXILiteS_s_axi is
    ...
    constant ADDR_SOURCE_DATA_0 : INTEGER := 16#18#;
    constant ADDR_SOURCE_CTRL   : INTEGER := 16#1c#;
    ...
    signal int_source          : UNSIGNED(31 downto 0);
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_SOURCE_DATA_0 =>
                        rdata_data <= RESIZE(int_source(31 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_SOURCE_DATA_0) then
                    int_source(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_source(31 downto 0));
                end if;
            end if;
        end if;
    end process;
