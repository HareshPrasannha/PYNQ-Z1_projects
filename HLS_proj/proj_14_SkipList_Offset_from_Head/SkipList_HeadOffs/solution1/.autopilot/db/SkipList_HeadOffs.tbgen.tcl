set C_TypeInfoList {{ 
"SkipList_HeadOffs" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[],{ "pointer": "0"}] }],[],""], 
"0": [ "node", {"struct": [[],[],[{ "val": [[32], "1"]},{ "offs": [[],  {"array": ["2", [2]]}]},{ "dummy": [[32], "1"]}],""]}], 
"1": [ "dat_typ", {"typedef": [[[], {"scalar": "int"}],""]}], 
"2": [ "dat_typ1", {"typedef": [[[], {"scalar": "int"}],""]}]
}}
set moduleName SkipList_HeadOffs
...
set C_modelName {SkipList_HeadOffs}
...
set C_modelArgMapList {[ 
	{ "Name" : "A_BUS", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a.val","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "a"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]},{"low":32,"up":63,"cElement": [{"cName": "a.offs","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "a"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 2}]}]},{"low":64,"up":95,"cElement": [{"cName": "a.offs","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "a"},"direction": "READONLY","cArray": [{"low" : 1,"up" : 1,"step" : 2}]}]},{"low":96,"up":127,"cElement": [{"cName": "a.dummy","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "a"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set NewPortList {[ 
	{ "name": "s_axi_CFG_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CFG", "role": "AWADDR" },"address":[{"name":"SkipList_HeadOffs","role":"start","value":"0","valid_bit":"0"},{"name":"SkipList_HeadOffs","role":"continue","value":"0","valid_bit":"4"},{"name":"SkipList_HeadOffs","role":"auto_start","value":"0","valid_bit":"7"},{"name":"a","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_CFG_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CFG", "role": "ARADDR" },"address":[{"name":"SkipList_HeadOffs","role":"start","value":"0","valid_bit":"0"},{"name":"SkipList_HeadOffs","role":"done","value":"0","valid_bit":"1"},{"name":"SkipList_HeadOffs","role":"idle","value":"0","valid_bit":"2"},{"name":"SkipList_HeadOffs","role":"ready","value":"0","valid_bit":"3"},{"name":"SkipList_HeadOffs","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.SkipList_HeadOffs_CFG_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.SkipList_HeadOffs_A_BUS_m_axi_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	A_BUS { m_axi {  { m_axi_A_BUS_AWVALID VALID 1 1 }  { m_axi_A_BUS_AWREADY READY 0 1 }  { m_axi_A_BUS_AWADDR ADDR 1 32 }  { m_axi_A_BUS_AWID ID 1 1 }  { m_axi_A_BUS_AWLEN LEN 1 8 }  { m_axi_A_BUS_AWSIZE SIZE 1 3 }  { m_axi_A_BUS_AWBURST BURST 1 2 }  { m_axi_A_BUS_AWLOCK LOCK 1 2 }  { m_axi_A_BUS_AWCACHE CACHE 1 4 }  { m_axi_A_BUS_AWPROT PROT 1 3 }  { m_axi_A_BUS_AWQOS QOS 1 4 }  { m_axi_A_BUS_AWREGION REGION 1 4 }  { m_axi_A_BUS_AWUSER USER 1 1 }  { m_axi_A_BUS_WVALID VALID 1 1 }  { m_axi_A_BUS_WREADY READY 0 1 }  { m_axi_A_BUS_WDATA DATA 1 128 }  { m_axi_A_BUS_WSTRB STRB 1 16 }  { m_axi_A_BUS_WLAST LAST 1 1 }  { m_axi_A_BUS_WID ID 1 1 }  { m_axi_A_BUS_WUSER USER 1 1 }  { m_axi_A_BUS_ARVALID VALID 1 1 }  { m_axi_A_BUS_ARREADY READY 0 1 }  { m_axi_A_BUS_ARADDR ADDR 1 32 }  { m_axi_A_BUS_ARID ID 1 1 }  { m_axi_A_BUS_ARLEN LEN 1 8 }  { m_axi_A_BUS_ARSIZE SIZE 1 3 }  { m_axi_A_BUS_ARBURST BURST 1 2 }  { m_axi_A_BUS_ARLOCK LOCK 1 2 }  { m_axi_A_BUS_ARCACHE CACHE 1 4 }  { m_axi_A_BUS_ARPROT PROT 1 3 }  { m_axi_A_BUS_ARQOS QOS 1 4 }  { m_axi_A_BUS_ARREGION REGION 1 4 }  { m_axi_A_BUS_ARUSER USER 1 1 }  { m_axi_A_BUS_RVALID VALID 0 1 }  { m_axi_A_BUS_RREADY READY 1 1 }  { m_axi_A_BUS_RDATA DATA 0 128 }  { m_axi_A_BUS_RLAST LAST 0 1 }  { m_axi_A_BUS_RID ID 0 1 }  { m_axi_A_BUS_RUSER USER 0 1 }  { m_axi_A_BUS_RRESP RESP 0 2 }  { m_axi_A_BUS_BVALID VALID 0 1 }  { m_axi_A_BUS_BREADY READY 1 1 }  { m_axi_A_BUS_BRESP RESP 0 2 }  { m_axi_A_BUS_BID ID 0 1 }  { m_axi_A_BUS_BUSER USER 0 1 } } }
}
