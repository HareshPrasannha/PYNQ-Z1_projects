...
define void @SkipList_HeadOffs(%struct.node.1* %a) nounwind {
  ...
  call void @llvm.dbg.value(metadata !{%struct.node.1* %a}, i64 0, metadata !56), !dbg !57 ; [debug line = 19:46] [debug variable = a]
  ...
  call void @llvm.dbg.declare(metadata !{[200 x i32]* %buff}, metadata !62), !dbg !66 ; [debug line = 27:7] [debug variable = buff]
  br label %1, !dbg !67                           ; [debug line = 46:14]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=3 type=i32]
  %temp_offs = phi i32 [ 0, %0 ], [ %temp_offs.1, %2 ] ; [#uses=3 type=i32]
  %exitcond2 = icmp eq i32 %i, 200, !dbg !67      ; [#uses=1 type=i1] [debug line = 46:14]
...
; <label>:2                                       ; preds = %1
  ...
  %buff.addr = getelementptr inbounds [200 x i32]* %buff, i32 0, i32 %i, !dbg !72 ; [#uses=1 type=i32*] [debug line = 55:5]
  store i32 %temp_offs, i32* %buff.addr, align 4, !dbg !72 ; [debug line = 55:5]
  %a.addr.1 = getelementptr inbounds %struct.node.1* %a, i32 %temp_offs, i32 1, i32 1, !dbg !73 ; [#uses=1 type=i32*] [debug line = 56:5]
  %temp_offs.1 = load volatile i32* %a.addr.1, align 4, !dbg !73 ; [#uses=1 type=i32] [debug line = 56:5]
  call void @llvm.dbg.value(metadata !{i32 %temp_offs.1}, i64 0, metadata !74), !dbg !73 ; [debug line = 56:5] [debug variable = temp_offs]
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0), i32 %rbegin3) nounwind, !dbg !75 ; [#uses=0 type=i32] [debug line = 59:3]
...
; <label>:3                                       ; preds = %1
  ...
  %a.addr = getelementptr inbounds %struct.node.1* %a, i32 %temp_offs.0.lcssa, i32 0, !dbg !78 ; [#uses=1 type=i32*] [debug line = 60:3]
  %4 = load volatile i32* %a.addr, align 4, !dbg !78 ; [#uses=0 type=i32] [debug line = 60:3]
  call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !79), !dbg !78 ; [debug line = 60:3] [debug variable = temp]
  br label %5, !dbg !81                           ; [debug line = 64:15]

; <label>:5                                       ; preds = %7, %3
  %j = phi i32 [ 0, %3 ], [ %j.1, %7 ]            ; [#uses=2 type=i32]
  %exitcond1 = icmp eq i32 %j, 49, !dbg !81       ; [#uses=1 type=i1] [debug line = 64:15]
  br i1 %exitcond1, label %8, label %.preheader.preheader, !dbg !81 ; [debug line = 64:15]

.preheader.preheader:                             ; preds = %5
  br label %.preheader, !dbg !83                  ; [debug line = 65:15]

.preheader:                                       ; preds = %6, %.preheader.preheader
  %i1 = phi i32 [ %i.2, %6 ], [ 1, %.preheader.preheader ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i1, 200, !dbg !83      ; [#uses=1 type=i1] [debug line = 65:15]
  br i1 %exitcond, label %7, label %6, !dbg !83   ; [debug line = 65:15]

; <label>:6                                       ; preds = %.preheader
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !86 ; [#uses=1 type=i32] [debug line = 65:32]
  call void (...)* @_ssdm_Unroll(i32 1, i32 0, i32 50, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !88 ; [debug line = 67:1]
  %buff.addr.1 = getelementptr inbounds [200 x i32]* %buff, i32 0, i32 %i1, !dbg !89 ; [#uses=2 type=i32*] [debug line = 70:5]
  %buff.load = load i32* %buff.addr.1, align 4, !dbg !89 ; [#uses=2 type=i32] [debug line = 70:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %buff.load) nounwind
  %a.addr.2 = getelementptr inbounds %struct.node.1* %a, i32 %buff.load, i32 1, i32 0, !dbg !89 ; [#uses=1 type=i32*] [debug line = 70:5]
  %a.load = load volatile i32* %a.addr.2, align 4, !dbg !89 ; [#uses=1 type=i32] [debug line = 70:5]
  store i32 %a.load, i32* %buff.addr.1, align 4, !dbg !89 ; [debug line = 70:5]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !90 ; [#uses=0 type=i32] [debug line = 75:4]
  %i.2 = add nsw i32 %i1, 1, !dbg !91             ; [#uses=1 type=i32] [debug line = 65:27]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !92), !dbg !91 ; [debug line = 65:27] [debug variable = i]
  br label %.preheader, !dbg !91                  ; [debug line = 65:27]

; <label>:7                                       ; preds = %.preheader
  %j.1 = add nsw i32 %j, 1, !dbg !93              ; [#uses=1 type=i32] [debug line = 64:30]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !94), !dbg !93 ; [debug line = 64:30] [debug variable = j]
  br label %5, !dbg !93                           ; [debug line = 64:30]

; <label>:8                                       ; preds = %5
  ret void, !dbg !95                              ; [debug line = 77:1]
}
...
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"SkipList_HeadOffs", metadata !"SkipList_HeadOffs", metadata !"_Z17SkipList_HeadOffsPV4node", metadata !6, i32 19, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.node.1*)* @SkipList_HeadOffs, null, null, metadata !22, i32 20} ; [ DW_TAG_subprogram ]
...
!57 = metadata !{i32 19, i32 46, metadata !5, null}
...
!72 = metadata !{i32 55, i32 5, metadata !70, null}
!73 = metadata !{i32 56, i32 5, metadata !70, null}
!74 = metadata !{i32 786688, metadata !59, metadata !"temp_offs", metadata !6, i32 45, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!75 = metadata !{i32 59, i32 3, metadata !70, null}
...
!78 = metadata !{i32 60, i32 3, metadata !59, null}
...
!81 = metadata !{i32 64, i32 15, metadata !82, null}
!82 = metadata !{i32 786443, metadata !59, i32 64, i32 3, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!83 = metadata !{i32 65, i32 15, metadata !84, null}
!84 = metadata !{i32 786443, metadata !85, i32 65, i32 4, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!85 = metadata !{i32 786443, metadata !82, i32 64, i32 34, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!86 = metadata !{i32 65, i32 32, metadata !87, null}
!87 = metadata !{i32 786443, metadata !84, i32 65, i32 31, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!88 = metadata !{i32 67, i32 1, metadata !87, null}
!89 = metadata !{i32 70, i32 5, metadata !87, null}
!90 = metadata !{i32 75, i32 4, metadata !87, null}
!91 = metadata !{i32 65, i32 27, metadata !84, null}
!92 = metadata !{i32 786688, metadata !84, metadata !"i", metadata !6, i32 65, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!93 = metadata !{i32 64, i32 30, metadata !82, null}
!94 = metadata !{i32 786688, metadata !82, metadata !"j", metadata !6, i32 64, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!95 = metadata !{i32 77, i32 1, metadata !59, null}
