; ModuleID = 'A:/COMP_ARCH/PYNQ_Projects/HLS_proj/proj_14_SkipList_Offset_from_Head/SkipList_HeadOffs/solution1/.autopilot/db/a.g.1.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

%struct.node.1 = type { i32, [2 x i32], i32 }
...
; [#uses=0]
define void @SkipList_HeadOffs(%struct.node.1* %a) nounwind {
  ...
  call void @llvm.dbg.value(metadata !{%struct.node.1* %a}, i64 0, metadata !56), !dbg !57 ; [debug line = 17:46] [debug variable = a]
  call void (...)* @_ssdm_op_SpecInterface(%struct.node.1* %a, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([6 x i8]* @.str2, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 16, i32 16, i32 16, i32 16, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !58 ; [debug line = 19:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([10 x i8]* @.str4, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([4 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !60 ; [debug line = 20:1]
  call void (...)* @_ssdm_DataPack(%struct.node.1* %a, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !61 ; [debug line = 21:1]
  call void @llvm.dbg.declare(metadata !{[200 x i32]* %buff}, metadata !62), !dbg !66 ; [debug line = 25:7] [debug variable = buff]
  br label %1, !dbg !67                           ; [debug line = 41:14]

; <label>:1                                       ; preds = %2, %0
  %i = phi i32 [ 0, %0 ], [ %i.1, %2 ]            ; [#uses=3 type=i32]
  %temp_offs = phi i32 [ 0, %0 ], [ %temp_offs.1, %2 ] ; [#uses=3 type=i32]
  %exitcond2 = icmp eq i32 %i, 200, !dbg !67      ; [#uses=1 type=i1] [debug line = 41:14]
  br i1 %exitcond2, label %3, label %2, !dbg !67  ; [debug line = 41:14]

; <label>:2                                       ; preds = %1
  %buff.addr = getelementptr inbounds [200 x i32]* %buff, i32 0, i32 %i, !dbg !69 ; [#uses=1 type=i32*] [debug line = 47:4]
  store i32 %temp_offs, i32* %buff.addr, align 4, !dbg !69 ; [debug line = 47:4]
  %a.addr.1 = getelementptr inbounds %struct.node.1* %a, i32 %temp_offs, i32 1, i32 1, !dbg !71 ; [#uses=1 type=i32*] [debug line = 48:4]
  %temp_offs.1 = load volatile i32* %a.addr.1, align 4, !dbg !71 ; [#uses=1 type=i32] [debug line = 48:4]
  call void @llvm.dbg.value(metadata !{i32 %temp_offs.1}, i64 0, metadata !72), !dbg !71 ; [debug line = 48:4] [debug variable = temp_offs]
  %i.1 = add nsw i32 %i, 1, !dbg !73              ; [#uses=1 type=i32] [debug line = 41:26]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !74), !dbg !73 ; [debug line = 41:26] [debug variable = i]
  br label %1, !dbg !73                           ; [debug line = 41:26]

; <label>:3                                       ; preds = %1
  %temp_offs.0.lcssa = phi i32 [ %temp_offs, %1 ] ; [#uses=1 type=i32]
  %a.addr = getelementptr inbounds %struct.node.1* %a, i32 %temp_offs.0.lcssa, i32 0, !dbg !75 ; [#uses=1 type=i32*] [debug line = 50:3]
  %4 = load volatile i32* %a.addr, align 4, !dbg !75 ; [#uses=0 type=i32] [debug line = 50:3]
  call void @llvm.dbg.value(metadata !{i32 %4}, i64 0, metadata !76), !dbg !75 ; [debug line = 50:3] [debug variable = temp]
  br label %5, !dbg !78                           ; [debug line = 54:15]

; <label>:5                                       ; preds = %7, %3
  %j = phi i32 [ 0, %3 ], [ %j.1, %7 ]            ; [#uses=2 type=i32]
  %exitcond1 = icmp eq i32 %j, 49, !dbg !78       ; [#uses=1 type=i1] [debug line = 54:15]
  br i1 %exitcond1, label %8, label %.preheader.preheader, !dbg !78 ; [debug line = 54:15]

.preheader.preheader:                             ; preds = %5
  br label %.preheader, !dbg !80                  ; [debug line = 55:15]

.preheader:                                       ; preds = %6, %.preheader.preheader
  %i1 = phi i32 [ %i.2, %6 ], [ 1, %.preheader.preheader ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %i1, 200, !dbg !80      ; [#uses=1 type=i1] [debug line = 55:15]
  br i1 %exitcond, label %7, label %6, !dbg !80   ; [debug line = 55:15]

; <label>:6                                       ; preds = %.preheader
  %buff.addr.1 = getelementptr inbounds [200 x i32]* %buff, i32 0, i32 %i1, !dbg !83 ; [#uses=2 type=i32*] [debug line = 60:5]
  %buff.load = load i32* %buff.addr.1, align 4, !dbg !83 ; [#uses=2 type=i32] [debug line = 60:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %buff.load) nounwind
  %a.addr.2 = getelementptr inbounds %struct.node.1* %a, i32 %buff.load, i32 1, i32 0, !dbg !83 ; [#uses=1 type=i32*] [debug line = 60:5]
  %a.load = load volatile i32* %a.addr.2, align 4, !dbg !83 ; [#uses=1 type=i32] [debug line = 60:5]
  store i32 %a.load, i32* %buff.addr.1, align 4, !dbg !83 ; [debug line = 60:5]
  %i.2 = add nsw i32 %i1, 1, !dbg !85             ; [#uses=1 type=i32] [debug line = 55:27]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !86), !dbg !85 ; [debug line = 55:27] [debug variable = i]
  br label %.preheader, !dbg !85                  ; [debug line = 55:27]

; <label>:7                                       ; preds = %.preheader
  %j.1 = add nsw i32 %j, 1, !dbg !87              ; [#uses=1 type=i32] [debug line = 54:30]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !88), !dbg !87 ; [debug line = 54:30] [debug variable = j]
  br label %5, !dbg !87                           ; [debug line = 54:30]

; <label>:8                                       ; preds = %5
  ret void, !dbg !89                              ; [debug line = 63:1]
}
...
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"SkipList_HeadOffs", metadata !"SkipList_HeadOffs", metadata !"_Z17SkipList_HeadOffsPV4node", metadata !6, i32 17, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void (%struct.node.1*)* @SkipList_HeadOffs, null, null, metadata !22, i32 18} ; [ DW_TAG_subprogram ]
...
!43 = metadata !{void (%struct.node.1*)* @SkipList_HeadOffs, metadata !44, metadata !45, metadata !46, metadata !47, metadata !48, metadata !49}
...
!56 = metadata !{i32 786689, metadata !5, metadata !"a", metadata !6, i32 16777233, metadata !9, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!57 = metadata !{i32 17, i32 46, metadata !5, null}
!58 = metadata !{i32 19, i32 1, metadata !59, null}
!59 = metadata !{i32 786443, metadata !5, i32 18, i32 1, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
!60 = metadata !{i32 20, i32 1, metadata !59, null}
!61 = metadata !{i32 21, i32 1, metadata !59, null}
!62 = metadata !{i32 786688, metadata !59, metadata !"buff", metadata !6, i32 25, metadata !63, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!63 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 6400, i64 32, i32 0, i32 0, metadata !15, metadata !64, i32 0, i32 0} ; [ DW_TAG_array_type ]
!64 = metadata !{metadata !65}
!65 = metadata !{i32 786465, i64 0, i64 199}      ; [ DW_TAG_subrange_type ]
!66 = metadata !{i32 25, i32 7, metadata !59, null}
!67 = metadata !{i32 41, i32 14, metadata !68, null}
!68 = metadata !{i32 786443, metadata !59, i32 41, i32 3, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!69 = metadata !{i32 47, i32 4, metadata !70, null}
!70 = metadata !{i32 786443, metadata !68, i32 41, i32 30, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!71 = metadata !{i32 48, i32 4, metadata !70, null}
!72 = metadata !{i32 786688, metadata !59, metadata !"temp_offs", metadata !6, i32 40, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!73 = metadata !{i32 41, i32 26, metadata !68, null}
!74 = metadata !{i32 786688, metadata !68, metadata !"i", metadata !6, i32 41, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!75 = metadata !{i32 50, i32 3, metadata !59, null}
!76 = metadata !{i32 786688, metadata !59, metadata !"temp", metadata !6, i32 24, metadata !77, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!77 = metadata !{i32 786485, null, metadata !"", null, i32 0, i64 0, i64 0, i64 0, i32 0, metadata !15} ; [ DW_TAG_volatile_type ]
!78 = metadata !{i32 54, i32 15, metadata !79, null}
!79 = metadata !{i32 786443, metadata !59, i32 54, i32 3, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!80 = metadata !{i32 55, i32 15, metadata !81, null}
!81 = metadata !{i32 786443, metadata !82, i32 55, i32 4, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!82 = metadata !{i32 786443, metadata !79, i32 54, i32 34, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!83 = metadata !{i32 60, i32 5, metadata !84, null}
!84 = metadata !{i32 786443, metadata !81, i32 55, i32 31, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!85 = metadata !{i32 55, i32 27, metadata !81, null}
!86 = metadata !{i32 786688, metadata !81, metadata !"i", metadata !6, i32 55, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!87 = metadata !{i32 54, i32 30, metadata !79, null}
!88 = metadata !{i32 786688, metadata !79, metadata !"j", metadata !6, i32 54, metadata !15, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!89 = metadata !{i32 63, i32 1, metadata !59, null}
