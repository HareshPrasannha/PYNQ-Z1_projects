...
if {[file isfile fetch_Retvoid.autotvin.dat]} {
	file delete -force fetch_Retvoid.autotvin.dat
}

if {[file isfile fetch_Retvoid.autotvout.dat]} {
	file delete -force fetch_Retvoid.autotvout.dat
}
