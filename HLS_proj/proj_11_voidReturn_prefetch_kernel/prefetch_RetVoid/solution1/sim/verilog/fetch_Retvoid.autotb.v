...
`define AUTOTB_DUT      fetch_Retvoid
`define AUTOTB_DUT_INST AESL_inst_fetch_Retvoid
`define AUTOTB_TOP      apatb_fetch_Retvoid_top
`define AUTOTB_LAT_RESULT_FILE "fetch_Retvoid.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fetch_Retvoid.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fetch_Retvoid_top
...
`define AUTOTB_TVIN_A_BUS_out_wrapc  "../tv/rtldatafile/rtl.fetch_Retvoid.autotvin_A_BUS.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.fetch_Retvoid.autotvin_a.dat"
`define AUTOTB_TVOUT_A_BUS  "../tv/cdatafile/c.fetch_Retvoid.autotvout_A_BUS.dat"
`define AUTOTB_TVOUT_A_BUS_out_wrapc  "../tv/rtldatafile/rtl.fetch_Retvoid.autotvout_A_BUS.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 960129;
