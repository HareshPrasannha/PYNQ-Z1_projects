...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fetch_Retvoid.autotvin.dat"
	set constFileTvOut       "fetch_Retvoid.autotvout.dat"
	set constFileHdlTvIn     "fetch_Retvoid.autohdltvin.dat"
	set constFileHdlTvOut    "fetch_Retvoid.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
