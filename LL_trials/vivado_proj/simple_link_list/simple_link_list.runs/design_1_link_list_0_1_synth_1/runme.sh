...
HD_PWD='A:/COMP_ARCH/PYNQ_Projects/LL_trials/vivado_proj/simple_link_list/simple_link_list.runs/design_1_link_list_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_link_list_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_link_list_0_1.tcl
