set C_TypeInfoList {{ 
"link_list" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[],{ "pointer": "0"}] }],[],""], 
"0": [ "node", {"struct": [[],[],[{ "val": [[],  {"scalar": "int"}]},{ "offs": [[],  {"scalar": "int"}]}],""]}]
}}
set moduleName link_list
...
set C_modelName {link_list}
set C_modelType { void 0 }
set C_modelArgList {
	{ A_BUS int 64 regular {axi_master 2}  }
	{ a int 32 regular {axi_slave 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A_BUS", "interface" : "axi_master", "bitwidth" : 64, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a.val","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "a"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 499,"step" : 1}]}]},{"low":32,"up":63,"cElement": [{"cName": "a.offs","cData": "int","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "a"},"direction": "READWRITE","cArray": [{"low" : 0,"up" : 499,"step" : 1}]}]}]} , 
...
set NewPortList {[ 
	{ "name": "s_axi_CFG_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CFG", "role": "AWADDR" },"address":[{"name":"link_list","role":"start","value":"0","valid_bit":"0"},{"name":"link_list","role":"continue","value":"0","valid_bit":"4"},{"name":"link_list","role":"auto_start","value":"0","valid_bit":"7"},{"name":"a","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_CFG_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CFG", "role": "ARADDR" },"address":[{"name":"link_list","role":"start","value":"0","valid_bit":"0"},{"name":"link_list","role":"done","value":"0","valid_bit":"1"},{"name":"link_list","role":"idle","value":"0","valid_bit":"2"},{"name":"link_list","role":"ready","value":"0","valid_bit":"3"},{"name":"link_list","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.link_list_CFG_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.link_list_A_BUS_m_axi_U", "Parent" : "0"}]}
