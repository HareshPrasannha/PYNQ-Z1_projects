...
`define AUTOTB_DUT      link_list
`define AUTOTB_DUT_INST AESL_inst_link_list
`define AUTOTB_TOP      apatb_link_list_top
`define AUTOTB_LAT_RESULT_FILE "link_list.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "link_list.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_link_list_top
...
`define AUTOTB_TVIN_A_BUS_out_wrapc  "../tv/rtldatafile/rtl.link_list.autotvin_A_BUS.dat"
`define AUTOTB_TVIN_a_out_wrapc  "../tv/rtldatafile/rtl.link_list.autotvin_a.dat"
`define AUTOTB_TVOUT_A_BUS  "../tv/cdatafile/c.link_list.autotvout_A_BUS.dat"
`define AUTOTB_TVOUT_A_BUS_out_wrapc  "../tv/rtldatafile/rtl.link_list.autotvout_A_BUS.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_A_BUS = 500;
