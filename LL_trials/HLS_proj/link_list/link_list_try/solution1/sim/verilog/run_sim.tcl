...
if {[file isfile link_list.autotvin.dat]} {
	file delete -force link_list.autotvin.dat
}

if {[file isfile link_list.autotvout.dat]} {
	file delete -force link_list.autotvout.dat
}
