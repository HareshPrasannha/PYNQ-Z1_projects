...
$(ObjDir)/link_list_test.cpp_pre.cpp.tb.o : link_list_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling link_list_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/link_list.cpp_pre.cpp.tb.o : link_list.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling link_list.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
