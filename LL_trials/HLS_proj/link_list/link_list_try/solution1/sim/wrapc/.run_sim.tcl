...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "link_list.autotvin.dat"
	set constFileTvOut       "link_list.autotvout.dat"
	set constFileHdlTvIn     "link_list.autohdltvin.dat"
	set constFileHdlTvOut    "link_list.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
